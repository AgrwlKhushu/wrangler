...
/**
 * This class {@link DataType} defines types of data that can be stored in a
 * workspace.
 */
public enum DataType {
    // This type represents any binary data - avro, protobuf or even other
    // charset.
    ...
    // Special format native to Dataprep, this converts the data into records
    // using the delimiter.
     ...
     * @return an instance of {@link DataType} based on it's string
     * representation, null if not found.
     */
    @Nullable
