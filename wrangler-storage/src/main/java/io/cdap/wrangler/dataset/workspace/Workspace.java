...
public class Workspace extends WorkspaceMeta {
    ...
    private Workspace(NamespacedId id, String name, String scope,
                      DataType type, Map<String, String> properties,
                      long created, long updated, @Nullable byte[] data,
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(super.hashCode(), id, created, updated,
                request);
    ...
    public static class Builder extends WorkspaceMeta.Builder<Builder> {
        ...
        public Workspace build() {
            return new Workspace(id, name, scope, type, properties, created,
