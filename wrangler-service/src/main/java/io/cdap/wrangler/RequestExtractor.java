...
/**
 * This class {@link RequestExtractor} provides utility functions for
 * extracting different aspects of the request.
...
public final class RequestExtractor {
    ...
    /**
     * Extracts the HTTP header, if the header is not present, then default
     * value is returned.
     *
    ...
    /**
     * Returns the content by converting it to UNICODE from the provided
     * charset.
     *
    ...
    public ConnectionMeta getConnectionMeta() {
        ...
        if (bodyStr == null) {
            throw new BadRequestException("No connection was found in the " +
                    "request body.");
        }
