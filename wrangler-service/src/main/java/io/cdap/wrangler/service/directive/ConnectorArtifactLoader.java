...
public class ConnectorArtifactLoader {
    private static final Logger LOG =
            LoggerFactory.getLogger(ConnectorArtifactLoader.class);
    ...
    public void reload() {
        ...
        for (ArtifactInfo artifact : artifacts) {
            // for now just support upgrading to system scope artifact to
            // save some logic in finding artifacts in
            ...
            for (PluginClass plugin : plugins) {
                ...
                PluginInfo info = new PluginInfo(name, Connector.PLUGIN_TYPE,
                        plugin.getCategory(), Collections.emptyMap(),
