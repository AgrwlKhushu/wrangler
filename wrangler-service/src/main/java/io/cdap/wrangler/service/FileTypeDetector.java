...
public class FileTypeDetector {
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(FileTypeDetector.class);
    ...
    public FileTypeDetector() {
        ...
        try (Scanner scanner =
                     new Scanner(getClass().getClassLoader().getResource(
                             "file.extensions").openStream(),
                             "UTF-8")) {
    ...
    /**
     * Attempts to detect the type of the file through extensions and by
    ...
    public String detectFileType(String location) {
        ...
        if (extensions.containsKey(extension)) {
            ...
            if (name.equalsIgnoreCase(location)) {
                // CDAP-14397 return text type if there is no extension in
                // the filename.
