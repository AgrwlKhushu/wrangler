 ...
 * complex types by callint toString().  This is done so the complex types
 * are shown
    ...
    private TypeAdapter<Row> rowClassAdapter(Gson gson) {
        ...
        return new TypeAdapter<Row>() {
            ...
            public Row read(JsonReader in) throws IOException {
                throw new UnsupportedOperationException("Reading Rows from " +
                        "Wrangler display format not supported.");
            }
        };
    }
        ...
        return new TypeAdapter<Object>() {
            ...
            public Object read(JsonReader in) throws IOException {
                throw new UnsupportedOperationException("Can't read object " +
                        "from it's string implementation");
            }
        };
    }
}
