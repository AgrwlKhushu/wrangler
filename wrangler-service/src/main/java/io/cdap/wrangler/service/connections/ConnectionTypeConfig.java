...
/**
 * Default connections to create at startup and connection types that needs
 * to be disabled
 */
public class ConnectionTypeConfig extends Config {
    ...
    public ConnectionTypeConfig(Set<ConnectionType> disabledTypes,
    ...
    /**
     * Return the connection configured to be shown as default in dataprep -
