...
public class WranglerDisplaySerializerTest {
    ...
    public void testRowSerialization() {
        Gson gson =
                new GsonBuilder().registerTypeAdapterFactory(new WranglerDisplaySerializer()).create();
        Row subRow = new Row();
        subRow.add("f1", 1);
        subRow.add("f2", "aaa");
        subRow.add("f3", 1L);
        ...
        String f14Str = "[\"A\",\"B\",\"C\"]";
        String f15Str = String.format("{\"f1\":%s,\"f2\":%s,\"f3\":%s," +
                        "\"f4\":%s,\"f5\":%s,\"f6\":%s,\"f7\":%s,\"f8\":%s,"
                        + "\"f9\":%s,\"f10\":%s,\"f11\":%s,\"f12\":%s," +
                        "\"f13\":%s,\"f14\":%s}", f1Str, f2Str, f3Str, f4Str,
                f5Str, f6Str,
                f7Str, f8Str, f9Str, f10Str, f11Str, f12Str, f13Str, f14Str);

        String outputTest = String.format("{\"f1\":%s,\"f2\":%s,\"f3\":%s," +
                        "\"f4\":%s,\"f5\":%s,\"f6\":%s,\"f7\":%s,"
                        + "\"f8\":%s,\"f9\":%s,\"f10\":%s,\"f11\":%s," +
                        "\"f12\":%s,\"f13\":%s,\"f14\":%s,\"f15\":%s}", f1Str
                , f2Str, f3Str,
                f4Str, f5Str, f6Str, f7Str, f8Str, f9Str, f10Str, f11Str,
                f12Str, f13Str, f14Str,
                f15Str);
