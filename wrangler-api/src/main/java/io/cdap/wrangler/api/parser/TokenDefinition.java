 ...
 * specified
 * by the user while defining a directive usage. All definitions of a token
 * are represented
 ...
 * For example :
 * <code>
 * TokenDefinition token = new TokenDefintion("column", TokenType
 * .COLUMN_NAME, null, 0, Optional.FALSE);
 * </code>
 *
 * <p>The class <code>TokenDefinition</code> includes methods for retrieveing
...
public final class TokenDefinition implements Serializable {
    ...
    public TokenDefinition(String name, TokenType type, String label,
                           int ordinal, boolean optional) {
        this.name = name;
        this.type = type;
        this.label = label;
    ...
    /**
     * @return Label associated with the token. Label provides a way to
     * override the usage description
    ...
    /**
     * @return Returns the oridinal number of this
     * <code>TokenDefinition</code> within
