...
/**
 * The <code>Mutation</code> class represents a collection of relations which
 * can be used to generate lineage for
 * a directive. It uses a UUID so that the name will be unique.
 *
 * <p>As this class is immutable, the constructor requires all the member
 * variables to be presented
 * for an instance of this object to be created.</p>
 * <p>
 * The class has methods to retrieve the <code>readable</code> text
 * describing the transformation, and
...
public final class Mutation implements Serializable {
    ...
    private Mutation(String readable, List<Relation> relations) {
        ...
        this.relations =
                Collections.unmodifiableList(new ArrayList<>(relations));
    }
    ...
    /**
     * @return a readable {@link String} version of the transformation to be
     * included in lineage.
     */
    ...
    /**
     * @return a {@link List} of {@link Relation} associated with the
     * transformation.
     */
    ...
    public static class Builder {
        ...
        /**
         * A relation that has association with a set of targets + all in the
         * output field.
         * This method is used usually during parse scenarios, where the
         * directive knows some part of the relation,
         * but unclear about the overall outputs it will generate
         * For example, csv parser will parse field body -> a,b,c, and still
         * preserve body.
         *
         * @param sources list of sources to be associated with targets and
         *                all output fields.
         * @param targets list of targets to be associated with the sources.
         * @return a instance of {@link Mutation.Builder}.
         */
        public Mutation.Builder all(Many sources, Many targets) {
            relations.add(new Relation(sources.columns(), targets.columns(),
                    Relation.Type.ALL));
            return this;
        }

        /**
         * A standard relation between source of {@link ColumnName} to target
         * of {@link ColumnName}.
         *
        ...
        /**
         * A relation that's conditional, depending on whether source and
         * target are same.
         *
        ...
        public Mutation.Builder conditional(String source, String target) {
            relation(source, source.equals(target) ? Many.of(target) :
                    Many.of(source, target));
            return this;
        }
         ...
         * @param targets {@link Many} target columns to be associated with
         *                source.
         * @return a instance of {@link Mutation.Builder}.
         */
         ...
         *
         * @param sources {@link Many} source columns to be associated with
         *                target.
