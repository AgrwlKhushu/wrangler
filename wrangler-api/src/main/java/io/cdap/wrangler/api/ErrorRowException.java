...
public class ErrorRowException extends Exception {
    ...
    public ErrorRowException(String directiveName, String errorMessage,
                             int code) {
    ...
    public ErrorRowException(String directiveName, String errorMessage,
        ...
        this(String.format("%s (ecode: %d, directive: %s)", errorMessage,
                code, directiveName), code, false, cause);
    }
    ...
    /**
     * @return Flag indicating whether this record should prevent further
     * wrangling.
     */
