 ...
 *
 * <p>This class provides methods for retrieving the wrapped value of token
 * parsed
 * as well the type of token the implementation of this interface represents
 * .</p>
 *
 * <p>It also provides method for providing the {@code JsonElement} of
 * implementation
 * of this interface.</p>
 */
@PublicEvolving
public interface Token extends Serializable {
     ...
     *
     * @return {@code JsonElement} object containing members of  implementing
     * class.
     */
    JsonElement toJson();
}
