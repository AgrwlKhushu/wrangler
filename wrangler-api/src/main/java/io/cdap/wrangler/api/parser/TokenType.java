...
public enum TokenType implements Serializable {
     ...
     * This type is associated with the token that is either enclosed within
     * a single quote(')
     ...
     * This type is associated with the token that is either a integer or
     * real number.
     */
    NUMERIC,
     ...
     * This type is associated with the token that either represents string
     * 'true' or 'false'.
     */
    BOOLEAN,
     ...
     * type.
     * This type is associated with the rule that is a collection of {@code
     * Boolean} values
     ...
     * type.
     * This type is associated with the comma separated text represented were
     * each text
     * is enclosed within a single quote (') or double quote (") and each
     * text is separated
     * by comma (,). E.g.
     * <code>
     * Text[,Text]*
    ...
    /**
     * Represents the enumerated type for the object of type {@code
     * NumericList} type.
     ...
     * Represents the enumerated type for the object of type {@code BoolList}
     * type.
     * This type is associated with the collection of {@code Bool} values
     * separated by
     * comma(,). E.g.
     * <code>
     * Boolean[,Boolean]*
     ...
     * Represents the enumerated type for the object of type {@code
     * Expression} type.
     * This type is associated with code block that either represents a
     * condition or
     * an expression. E.g.
     * <code>
     ...
     * types.
     * This type is associated with a collection of range represented in the
     * form shown
     * below
     * <code>
    ...
    /**
     * Represents the enumerated type for the object of type {@code String}
     * with restrictions
