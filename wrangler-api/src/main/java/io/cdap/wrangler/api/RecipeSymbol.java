 ...
 * constructs <code>RecipeSymbol</code> using the <code>RecipeSymbol
 * .Builder</code></p>
 */
@PublicEvolving
public final class RecipeSymbol {
    ...
    private RecipeSymbol(String version, Set<String> loadableDirectives,
    ...
    /**
     * Static method for creating an instance of the {@code RecipeSymbol
     * .Builder}.
     *
     ...
     *
     * @return An empty set if there are not directives to be loaded
     * dynamically,
     ...
     *
     * <p>Fewer than number of directives is because of the '#pragma'
     * directives</p>
     *
     * @return
     */
    ...
    /**
     * Returns an iterator to the list of token groups maintained by this
     * object.
     *
    ...
    /**
     * This method <code>toJson</code> returns the <code>JsonElement</code>
     * object
    ...
    public static final class Builder {
         ...
         * allows one to extract and add the version to the
         * <code>RecipeSymbol.</code>
         *
        ...
        /**
         * A Recipe can specify the pragma instructions for loading the
         * directives
        ...
        /**
         * Returns a fully constructed and valid <code>RecipeSymbol</code>
         * object.
         *
