...
/**
 * This class {@link UsageDefinition} provides a way for users to registers
 * the argument for UDDs.
 * <p>
 * {@link UsageDefinition} is a collection of {@link TokenDefinition} and the
 * name of the directive
 * itself. Each token specification has an associated ordinal that can be
 * used to position the argument
 * within the directive.
 * <p>
 * Following is a example of how this class can be used.
 * <code>
 * UsageDefinition.Builder builder = UsageDefinition.builder();
 * builder.add("col1", TypeToken.COLUMN_NAME); // By default, this field is
 * required.
 * builder.add("col2", TypeToken.COLUMN_NAME, false); // This is a optional
 * field.
...
public final class UsageDefinition implements Serializable {
    ...
    private UsageDefinition(String directive, int optionalCnt,
     ...
     * object. In order to create a <code>UsageDefinition</code>, a builder
     * has to created.
     *
     * <p>This builder is provided as user API for constructing the usage
     * specification
     * for a directive.</p>
     *
     * @param directive name of the directive for which the builder is
     *                  created for.
     * @return A <code>UsageDefinition.Builder</code> object that can be used
     * to construct
    ...
    /**
     * This method returns the list of <code>TokenDefinition</code> that
     * should be
        ...
        for (TokenDefinition token : tokens) {
            ...
            if (token.label() != null) {
                ...
                if (token.type().equals(TokenType.DIRECTIVE_NAME)) {
                    ...
                    sb.append("start:end=[bool|text|numeric][," +
    ...
    public static final class Builder {
        ...
        public void define(String name, TokenType type) {
            TokenDefinition spec = new TokenDefinition(name, type, null,
                    currentOrdinal, Optional.FALSE);
            currentOrdinal++;
            tokens.add(spec);
        }
         ...
         * additional optional
         * for the label that is used during creation of the usage for the
         * directive.
         *
         * @param name  of the token in the definition of a directive.
         * @param type  of the token to be extracted.
        ...
        public void define(String name, TokenType type, String label) {
            TokenDefinition spec = new TokenDefinition(name, type, label,
                    currentOrdinal, Optional.FALSE);
            currentOrdinal++;
            tokens.add(spec);
        }
        ...
        /**
         * Method allows users to specify a field as optional in combination
         * to the
         ...
         * Method allows users to specify a field as optional in combination
         * to the
         * name of the token, the type of token and also the ability to
         * specify a label
         * for the usage.
         *
         * @param name     of the token in the definition of a directive.
