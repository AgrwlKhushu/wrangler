...
public class Encode implements Directive, Lineage {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        if (!value.equals("BASE64") && !value.equals("BASE32") && !value.equals("HEX")) {
            throw new DirectiveParseException(
                    NAME, String.format("Type of encoding specified '%s' is " +
            ...
            if (object instanceof String) {
                ...
                throw new DirectiveExecutionException(
                        NAME, String.format("Column '%s' has invalid type " +
                                "'%s'. It should be of type 'String' or 'byte" +
                                " array'.",
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Encoded column '%s' using method '%s'", column,
                        method.getType())
