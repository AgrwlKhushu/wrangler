...
public class SplitURL implements Directive, Lineage {
                ...
                if (object instanceof String) {
                    try {
                        ...
                        throw new DirectiveExecutionException(
                                NAME, String.format("Malformed url '%s' found" +
                                " in column '%s'.", (String) object, column),
                                e);
                    }
                } else {
                    throw new DirectiveExecutionException(
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Split column '%s' into url parts as columns '%s', " +
                                "'%s', '%s', '%s', '%s', '%s', '%s'",
                        column, protocolCol, authCol, hostCol, portCol,
                        pathCol, queryCol, fileCol)
                .relation(column, Many.of(column, protocolCol, authCol,
                        hostCol, portCol, pathCol, queryCol, fileCol))
                .build();
    }
}
