...
public class CharacterCut implements Directive, Lineage {
            ...
            if (idx != -1) {
                ...
                if (value == null) {
                    throw new DirectiveExecutionException(
                            ...
                            "It should be a non-null 'String'.", source));
                }

                if (value instanceof String) {
                    String result = Unix4j.fromString((String) value).cut("-c"
                            , range).toStringResult();
                ...
                throw new DirectiveExecutionException(NAME,
                        "Scope column '" + source + "' does not exist.");
            }
        }
        return rows;
    }
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable(String.format("Character cut from column %s to " +
                                "destination %s using range %s",
