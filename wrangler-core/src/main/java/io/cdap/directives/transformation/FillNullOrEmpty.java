...
@Description("Fills a value of a column with a fixed value if it is either " +
        "null or empty.")
public class FillNullOrEmpty implements Directive, Lineage {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        if (value != null && value.isEmpty()) {
            throw new DirectiveParseException(NAME, "Fixed value cannot be an" +
                    " empty string");
        }
    }
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Filled column '%s' values that were null or empty " +
                        "with value %s", column, value)
