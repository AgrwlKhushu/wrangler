...
public class Stemming implements Directive, Lineage {
            ...
            if (idx != -1) {
                ...
                if ((object instanceof List || object instanceof String[] || object instanceof String)) {
                    ...
                    try {
                        ...
                        throw new DirectiveExecutionException(
                                NAME, String.format("Unable to apply porter " +
                                        "stemmer on column '%s'. %s", column,
                                e.getMessage()), e);
                    }
                } else {
                    throw new DirectiveExecutionException(
                            NAME, String.format("Invalid type '%s' of column " +
                                    "'%s'. It should be of type 'String', " +
                                    "Array of String' or 'List of String'.",
                            column,
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Reduced derived words using Porter technique from " +
                        "column '%s'", column)
