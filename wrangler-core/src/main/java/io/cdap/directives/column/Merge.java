...
@Description("Merges values from two columns using a separator into a new " +
        "column.")
public class Merge implements Directive, Lineage {
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Merged column '%s' and '%s' using delimiter '%s' " +
                        "into column '%s'", col1, col2, delimiter, dest)
