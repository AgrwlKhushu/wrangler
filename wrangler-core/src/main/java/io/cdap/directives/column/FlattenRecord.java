 ...
 * <p>
 * The directive takes multiple columns of type "Row" as brings all its
 * elements up a level.
 * Topmost elements will be set under new columns prefixed with the name of
 * the parent column
 * followed by an underscore. Existing columns with the same name will be
            ...
            for (String column : columns) {
                ...
                if (!(object instanceof Row)) {
                    throw new DirectiveExecutionException(
                            NAME,
                            String.format("Column '%s' has invalid type '%s'." +
                                            " It should be of type 'Record'.",
                ...
                for (Pair<String, Object> field : rowColumns.getFields()) {
                    columnName = String.format("%s_%s", column,
                            field.getFirst());
