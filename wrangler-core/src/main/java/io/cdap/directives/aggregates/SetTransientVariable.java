...
/**
 * A directive that defines a transient variable who's life-expectancy is
 * only within the record.
 * <p>
 * The value set as transient variable is available to all the directives
 * after that. But, it's
...
@Description("Sets the value for a transient variable for the record being " +
        "processed.")
