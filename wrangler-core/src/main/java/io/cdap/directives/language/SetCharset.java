 ...
 * <p>
 * This directive will convert the data from {@link Byte[]} or
 * {@link ByteBuffer}
...
public class SetCharset implements Directive, Lineage {
    ...
    public List<Row> execute(List<Row> rows, ExecutorContext context) throws DirectiveExecutionException,
        ...
        for (Row row : rows) {
            ...
            if (object instanceof byte[]) {
                ...
                throw new DirectiveExecutionException(
                        NAME, String.format("Column '%s' is of invalid type " +
                                "'%s'. It should be of type 'byte array' or " +
                                "'ByteBuffer'.", column,
            ...
            try {
                ...
                throw new DirectiveExecutionException(
                        NAME, String.format("Can not convert to character set" +
                        " '%s', %s", charset, e.getMessage()), e);
            }
        }
        return rows;
    }
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Changed character set of column '%s' to '%s'",
                        column, charset)
