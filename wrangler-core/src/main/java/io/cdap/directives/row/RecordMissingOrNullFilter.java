...
/**
 * Filters records if they don't have all the columns specified or they have
 * null values or combination.
 */
...
public class RecordMissingOrNullFilter implements Directive, Lineage {
    ...
    public Mutation lineage() {
        ...
        Mutation.Builder builder = Mutation.builder()
                .readable("Filtered null or empty records based on check on " +
                        "columns '%s'", cols);
