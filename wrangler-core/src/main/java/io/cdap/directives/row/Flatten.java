...
@Description("Separates array elements of one or more columns into individual" +
        " records, copying the other columns.")
public class Flatten implements Directive, Lineage {
                        ...
                        if (value == null) {
                            ...
                            if (v == null) {
                                ...
                                if (v instanceof JsonElement) {
                                    r.setValue(locations[i],
                                            JsParser.getValue((JsonElement) v));
                                } else {
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Expanded to individual records based on values in " +
                        "columns '%s''", Arrays.asList(columns))
