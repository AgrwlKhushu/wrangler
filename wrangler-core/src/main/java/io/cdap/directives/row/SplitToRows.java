...
@Description("Splits a column into multiple rows, copies the rest of the " +
        "columns.")
public class SplitToRows implements Directive, Lineage {
            ...
            if (idx != -1) {
                ...
                if (object == null) {
                    throw new DirectiveExecutionException(
                            ...
                            "It should be a non-null 'String'.", column));
                }
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Split column '%s' into multiple rows using " +
                        "expressions '%s'", column, regex)
