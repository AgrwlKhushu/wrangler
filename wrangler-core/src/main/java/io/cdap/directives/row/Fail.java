...
public class Fail implements Directive, Lineage {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        if (expression.value().isEmpty()) {
            throw new DirectiveParseException(
                    NAME, "No condition has been specified. Make sure " +
            ...
            try {
                ...
                if (result.getBoolean()) {
                    throw new DirectiveExecutionException(
                            NAME, String.format("Condition '%s' evaluated to " +
                            "true. Terminating processing.", condition));
                }
            } catch (ELException e) {
    ...
    public Mutation lineage() {
        Mutation.Builder builder = Mutation.builder()
                .readable(String.format("Pipeline set to fail based on " +
