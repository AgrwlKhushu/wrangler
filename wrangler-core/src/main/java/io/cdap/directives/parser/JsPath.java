...
/**
 * A Json Path Extractor Stage for parsing the {@link Row} provided based on
 * configuration.
 */
...
public class JsPath implements Directive, Lineage {
            ...
            if (!(value instanceof String ||
                ...
                throw new DirectiveExecutionException(
                        NAME, String.format("Column '%s' is of invalid type " +
                                ...
                                "or 'JsonObject' or 'JsonArray'.", src,
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Extracted value from column '%s' represented as " +
                                "Json to destination column '%s' using path " +
                                "'%s'",
                        src, dest, path)
