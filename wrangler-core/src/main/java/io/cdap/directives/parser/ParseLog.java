...
public class ParseLog implements Directive, Lineage {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        try {
            parser.addParseTarget(LogLine.class.getMethod("setValue",
                    String.class, String.class), paths);
        } catch (NoSuchMethodException e) {
            // This should never happen, as the class is defined within this
            // class.
        }
    }
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Parsed column '%s' as webserver log using format " +
                        "'%s'", column, format)
