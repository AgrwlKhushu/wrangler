...
public class ParseDateTime implements Directive, Lineage {
    ...
    public void initialize(Arguments args) throws DirectiveParseException {
        ...
        try {
            ...
            throw new DirectiveParseException(NAME, String.format("'%s' is an" +
                    " invalid datetime format.", this.format),
                    exception);
        }
    }
        ...
        for (Row row : rows) {
            ...
            try {
                ...
                throw new ErrorRowException(NAME, String.format("Value %s for" +
                                " column %s is not in expected format %s",
    ...
    public Mutation lineage() {
        return Mutation.builder()
                .readable("Parsed column '%s' in format '%s' as datetime",
                        column, format)
