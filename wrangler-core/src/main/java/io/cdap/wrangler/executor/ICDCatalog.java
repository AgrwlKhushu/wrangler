 ...
 *
 * <p>
 * icd10cm_code_2016.txt contains all ICD-10-CM (diagnosis) codes valid for
 * FY2016.
...
public final class ICDCatalog implements StaticCatalog {
    ...
    public boolean configure() {
        ...
        InputStream in =
                ICDCatalog.class.getClassLoader().getResourceAsStream(filename);
        if (in == null) {
            return false;
        }
    ...
    /**
     * Looks up a ICD Code in the catalog and the associated {@link ICDCode}
     * value.
     *
