            ...
            for (int i = 0; i < row.width(); ++i) {
                ...
                if (object instanceof String) {
                    ...
                    if (value.isEmpty()) {
                        ...
                        // this call is very expensive for string > 2000
                        // characters, took seconds to return
                        Map<String, List<String>> finds =
                                engine.findWithType(value);
                        for (String find : finds.keySet()) {
                            types.increment(column, find);
                        }
                        // TODO: this is a workaround for CDAP-18262, to
                        //  proper fix we should revisit this computation logic
