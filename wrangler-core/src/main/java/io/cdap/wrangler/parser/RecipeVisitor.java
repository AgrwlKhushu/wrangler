 ...
 *
 * <p>In order to understand what's being invoked, please look at the grammar
 * file
 ...
 *
 * <p> As the <code>ParseTree</code> is walking through the call graph, it
 * generates
 ...
 * information like
 * <code>SourceInfo</code>. A collection of <code>TokenGroup</code>
 * consistutes a <code>RecipeSymbol</code>
...
public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
     ...
     * individual
     * Directive. This method is invoked on every visit to a new directive in
     * the recipe.
     */
    @Override
    ...
    /**
     * A Directive can include identifiers, this method extracts that token
     * that is being
     ...
     * value pairs),
     * this method extracts that token that is being identified as token of
     * type <code>Properties</code>.
     */
    @Override
     ...
     * directives being specified
     * from the <code>DirectiveRegistry</code>. These do not affect the data
     * flow.
     *
     * <p>E.g. <code>#pragma load-directives test1, test2, test3;</code> will
     * collect the tokens
    ...
    /**
     * A Directive can include number ranges like start:end=value[,
     * start:end=value]*. This
     * visitor method allows you to collect all the number ranges and create
     * a token type
     * <code>Ranges</code>.
     */
    @Override
    ...
    /**
     * A Directive can consist of column specifiers. These are columns that
     * the directive
     * would operate on. When a token of type column is visited, it would
     * generate a token
    ...
    /**
     * A Directive can consist of text field. These type of fields are
     * enclosed within
     * a single-quote or a double-quote. This visitor method extracts the
     * string value
    ...
    /**
     * This visitor methods extracts the list of columns specified. It
     * creates a token
    ...
    /**
     * This visitor methods extracts the list of numeric specified. It
     * creates a token
    ...
    /**
     * This visitor methods extracts the list of booleans specified. It
     * creates a token
    ...
    /**
     * This visitor methods extracts the list of strings specified. It
     * creates a token
