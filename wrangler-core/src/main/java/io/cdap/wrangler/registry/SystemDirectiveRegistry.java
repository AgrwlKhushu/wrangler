...
/**
 * This class is implementation of {@link DirectiveRegistry} for maintaining
 * a registry
 * of system provided directives. The directives maintained within this
 * registry and
 ...
 * implement the interface {@link Directive}. Instead of scanning entire JAR,
 * it uses the
 * package name a starting point for scanning the classes that implement the
 * <tt>Directive</tt>
 * interface.</p>
 *
 * <p>For every class found, this scan will create a instance of
 * {@link DirectiveInfo}
...
public final class SystemDirectiveRegistry implements DirectiveRegistry {
     ...
     * @throws DirectiveLoadException thrown if there are any issue loading
     *                                the directive.
     */
    public SystemDirectiveRegistry(List<String> namespaces) throws DirectiveLoadException {
        ...
        for (String namespace : namespaces) {
            try {
                ...
                Set<Class<? extends Directive>> system =
                        reflections.getSubTypesOf(Directive.class);
    ...
    /**
     * Given the name of the directive, returns the information related to
     * the directive.
     *
     ...
     * Given the name of the directive, returns the information related to
     * the directive.
     * This method is specific to system registry as system registry does not
     * need namespace
     * parameter.
     *
     * @param name of the directive to be retrieved from the registry.
