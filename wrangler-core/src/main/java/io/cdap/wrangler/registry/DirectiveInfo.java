...
/**
 * This class <code>DirectiveInfo</code> contains information about each
 * individual
 * directive loaded. It also holds additional information like usage,
 * description,
...
public final class DirectiveInfo {
     ...
     */
    private DirectiveInfo(DirectiveScope scope,
                          Class<? extends Directive> directive,
                          @Nullable ArtifactId artifactId) {
        this.directive = directive;
        this.directiveClass =
                new DirectiveClass(directive.getAnnotation(Name.class).value(),
                        directive.getName(), scope, artifactId);

        Description desc = directive.getAnnotation(Description.class);
        if (desc == null) {
            this.description = "No description specified for directive class " +
                    "'" + directive.getSimpleName() + "'";
        } else {
    ...
    /**
     * Creates a {@link DirectiveInfo} of the given class coming from the
     * {@link DirectiveScope#SYSTEM} scope.
     */
    ...
    /**
     * Creates a {@link DirectiveInfo} of the given class coming from the
     * {@link DirectiveScope#USER} scope.
     */
    public static DirectiveInfo fromUser(Class<? extends Directive> cls,
                                         @Nullable ArtifactId artifactId)
            throws InstantiationException, IllegalAccessException {
    ...
    /**
     * @return a {@link DirectiveClass} which contains the class information
     * of this directive.
     */
    ...
    /**
     * @return a <code>Boolean</code> type that indicates if
     * <code>Directive</code> has been deprecated or not.
     */
    ...
    /**
     * @return a <code>Scope</code> type specifying either USER or SYSTEM
     * scope the directive is deployed in.
     */
    ...
    /**
     * @return a <code>String</code> type containing the usage information of
     * the directive.
     */
    public String usage() {
        if (usage != null) {
    ...
    /**
     * @return a <code>String</code> type providing the description for a
     * directive.
     */
    ...
    /**
     * @return a <code>String</code> type specifying the definition
    ...
    /**
     * @return a <code>String</code> array providing the categories the
     * directive is associated with.
     */
     ...
     *                                reflectively create an instance
     * @throws InstantiationException Thrown when an application tries to
     *                                create an instance of a class
     *                                using the {@code newInstance} method in
     *                                class {@code Class}
     */
    public Directive instance() throws IllegalAccessException,
