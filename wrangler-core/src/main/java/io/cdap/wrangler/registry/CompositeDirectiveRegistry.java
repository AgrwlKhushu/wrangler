 ...
 *
 * <p>It implements the <tt>DirectiveRegistry</tt> interface. Search for a
 * directives
...
public final class CompositeDirectiveRegistry implements DirectiveRegistry {
    ...
    /**
     * This method looks for the <tt>directive</tt> in all the registered
     * registries.
     *
     * <p>The order of search is as specified by the collection order. Upon
     * finding
     * the first valid instance of directive, the <tt>DirectiveInfo</tt> is
     * returned.</p>
     *
    ...
    public ArtifactSummary getLatestWranglerArtifact() {
        ...
        for (DirectiveRegistry registry : registries) {
            ...
            if (latestArtifact == null) {
                ...
                latestArtifact =
                        ArtifactSummaryComparator.pickLatest(latestArtifact,
                                artifact);
            }
        }
