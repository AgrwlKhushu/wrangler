...
public class ConvertString {
    ...
    /**
     * This constructor is used to some cases but except removing a specify
     * repeated String
    ...
    /**
     * Remove trailing and leading characters and the remove Character is
     * whitespace only. <br/>
     * <br/>
     * Note: this is not equals input.trim() for example: <br/>
     * when the input is ("\t" + "abc "), this method will return ("\t" +
     * "abc"),<br/>
