...
public final class MessagesFactory {
    ...
    /**
     * @return Default {@link Messages} with resource bundle 'user' and
     * default {@link Locale}
     */
    ...
    /**
     * Creates a {@link Messages} with specified
     * {@link java.util.ResourceBundle} name and default {@link Locale}
     *
    ...
    /**
     * Creates a {@link Messages} with specified
     * {@link java.util.ResourceBundle} name and {@link Locale}
     *
     * @param name   of the base bundle for creating {@link Messages}
