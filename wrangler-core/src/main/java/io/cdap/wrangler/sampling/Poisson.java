...
/**
 * A sampler implementation based on the Poisson Distribution. While sampling
 * elements with fraction
...
public class Poisson<T> extends Sampler<T> {
    ...
    // THRESHOLD is a tuning parameter for choosing sampling method according
    // to the fraction.
    ...
    /**
     * Sample the input elements, for each input element, generate its count
     * following a poisson
     * distribution.
     *
