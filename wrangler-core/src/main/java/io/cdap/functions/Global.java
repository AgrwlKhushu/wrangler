...
public final class Global {
     ...
     */
    public static String padAtStart(String string, int minLength,
                                    char padChar) {
     ...
     * copies of an input string. For
     * example, {@code repeat("hey", 3)} returns the string {@code "heyheyhey"}.
     *
     * @param string any non-null string
     * @param count  the number of times to repeat it; a nonnegative integer
     * @return a string containing {@code string} repeated {@code count}
    ...
    /**
     * Returns an empty string if the input column is null, otherwise returns
    ...
    /**
     * Returns zero if the input column is null, otherwise returns the input
     * column value.
     *
     * @param value to be evaluated.
     * @return Empty string if null, else 'value'
