...
public final class JsonFunctions {
    ...
    @Deprecated
    public static JsonElement select(String json, String path,
                                     String... paths) {
    ...
    @Deprecated
    public static JsonElement select(String json, boolean toLower,
    ...
    @Deprecated
    public static JsonElement select(JsonElement element, String path,
                                     String... paths) {
        return select(element, true, path, paths);
    }

    @Deprecated
    public static JsonElement select(JsonElement element, boolean toLower,
                                     String path, String... paths) {
        if (toLower) {
            element = keysToLower(element);
        }
        DocumentContext context =
                JsonPath.using(GSON_CONFIGURATION).parse(element);
        if (paths.length == 0) {
    ...
    @Deprecated
    public static JsonElement drop(String json, String field,
                                   String... fields) {
        JsonElement element = PARSER.parse(json);
     ...
     * <p>
     * This method recursively iterates through the Json to delete one or
     ...
     */
    @Deprecated
    public static JsonElement drop(JsonElement element, String field,
                                   String... fields) {
    ...
    /**
     * This function lowers the keys of the json. it applies this
     * transformation recurively.
     *
    ...
    /**
     * Parses a column or string to JSON. This is equivalent to <code>JSON
     * .parse()</code>
    ...
    /**
     * Parses a column or string to JSON. If the json string is invalid, this
     * method will return a JsonNull
     *
     * @param json string representation of json.
     * @return parsed json
     */
