...
public final class DateAndTime {
    ...
    /**
     * Return the {@link LocalDate} the string represents. If the string is
    ...
    /**
     * Return the {@link LocalTime} the string represents. If the string is
     * null, this method will return null.
     */
    ...
    /**
     * Return the {@link LocalDateTime} the string represents. If the string
    ...
    /**
     * Returns a date object by adding an integer to a current date. If this
     * integer is null, current date will
     * be returned. The integer can be negative to return a date that is
     ...
     * integer is null, baseline date will be
     * returned. The integer can be negative to return a date that is earlier
     * than the baseline date.
     * If baseline is null, the current date will be used. If days is null,
     ...
     * If any input is null, null will be
     * returned.
     *
     ...
     */
    public static LocalDate DateFromComponents(Integer year, Integer month,
                                               Integer day) {
        return year == null || month == null || day == null ? null :
                LocalDate.of(year, month, day);
    }

    /**
     * Returns a date from the given Julian day number. The day number will
     * be treated as 0 if it is null.
     *
    ...
    public static LocalDate DateFromJulianDay(Long julianDay) {
        DateTime datetime =
                new DateTime(DateTimeUtils.fromJulianDay(julianDay == null ?
                        0d : julianDay.doubleValue()));
        return LocalDate.of(datetime.getYear(), datetime.getMonthOfYear(),
                datetime.getDayOfMonth());
    }

    /**
     * Returns the given date, with offsets applied from the given year
     * offset, month offset, and day of month offset.
     * offsets are given as three separate values. The offset values can each
     * be positive, zero, or negative.
     * If base line is null, null will be returned. If the offset is null, it
     ...
     */
    public static LocalDate DateOffsetByComponents(LocalDate baseline,
                                                   Integer yearOffset,
                                                   Integer monthOffset,
                                                   Integer daysOffset) {
        return baseline == null ? null :
                baseline.plusYears(yearOffset == null ? 0 :
                                yearOffset.longValue())
                        .plusMonths(monthOffset == null ? 0 :
                                monthOffset.longValue())
                        .plusDays(daysOffset == null ? 0 :
                                daysOffset.longValue());
    }

    /**
     * Returns the number of days from the source date to the given date. If
     * any date is null, null will be returned.
     *
     ...
     */
    public static Long DaysSinceFromDate(LocalDate source,
                                         LocalDate destination) {
        return source == null || destination == null ? null :
                ChronoUnit.DAYS.between(source, destination);
    }

    /**
     * Returns the number of days in the month in the given base date. If
    ...
    /**
     * Returns the number of days in the year in the given base date. If date
    ...
    /**
     * Returns the given date offset by the given number of days. The offset
     * value can be positive, zero, or negative.
     * If date is null, null will be returned. If offset is null, it will be
     * treated as 0.
     *
     * @param date       date of {@link LocalDate} type.
     ...
     */
    public static LocalDate DateOffsetByDays(LocalDate date,
                                             Integer daysOffset) {
        return date == null ? null : date.plusDays(daysOffset == null ? 0 :
                daysOffset);
    }

    /**
     * Returns the hours portion of a time. If time is null, null will be
     * returned.
     *
    ...
    /**
     * Returns a Julian day number from the given date. If date is null, null
     * will be returned.
     *
    ...
    /**
     * Returns the Nanosecond portion of a time. If time is null, null will
     * be returned.
     *
     * @param time of {@link LocalTime} type.
    ...
    /**
     * Returns the microsecond portion of a time. If time is null, null will
     * be returned.
     *
     * @param time of {@link LocalTime} type.
    ...
    /**
     * Returns the millisecond portion of a time. If time is null, null will
     * be returned.
     *
     * @param time of {@link LocalTime} type.
    ...
    /**
     * Returns the number of seconds from midnight to the given time. If time
     * is null, null will be returned.
     *
     * @param time of {@link LocalTime} type.
    ...
    /**
     * Returns the day of the month from the given date. If date is null,
    ...
    /**
     * Returns the month number from the given date. If date is null, null
     * will be returned.
     *
     * @param date of {@link LocalDate} type.
     ...
     * source date.
     * The day of the week is specified as the full name, for example,
     * thursday, or a
     * three-letter abbreviation, for example, thu.
     * If source is null, null will be returned. If the day of the week is
     * null, source will be returned.
     *
     * @param source        of {@link LocalDate} type.
     * @param textDayOfWeek text day of the week.
     * @return earliest day from the date.
     */
    public static LocalDate NextWeekdayFromDate(LocalDate source,
     ...
     * specified number of weeks from the source date.
     * The day of the week is specified as the full name, for example,
     * thursday, or a three-letter abbreviation,
     * for example, thu. The offset values can be positive, negative, or zero.
     * If source is null, null will be returned. If textDayOfWeek is null,
     ...
     */
    public static LocalDate NthWeekdayFromDate(LocalDate source,
                                               String textDayOfWeek,
                                               Number offset) {
        ...
        for (int i = 0; i < counter; i++) {
            target = target.with(offset.intValue() > 0 ?
                    TemporalAdjusters.next(getDayOfWeek(textDayOfWeek)) :
    ...
    /**
     * Returns the date of the specified day of the week that is the most
     * recent day before the source date.
     * The day of the week is specified as the full name, for example,
     * thursday, or a three-letter abbreviation,
     * for example, thu.
     * If source is null, null will be returned. If the day of the week is
     ...
     */
    public static LocalDate PreviousWeekdayFromDate(LocalDate source,
                                                    String textDayOfWeek) {
        return source == null ? null : (textDayOfWeek == null ? source :
     ...
     */
    public static Long SecondsSinceFromDateTime(LocalDateTime source,
                                                LocalDateTime destination) {
        return source == null || destination == null ? null :
                Duration.between(destination, source).getSeconds();
    }
    ...
    /**
     * Returns a time from the given hours, minutes, seconds, and
     * microseconds, given as four separate values.
     ...
     */
    public static LocalTime TimeFromComponents(Integer hours, Integer mins,
                                               Integer seconds,
    ...
    /**
     * Returns the time given the number of seconds since midnight. If
     * seconds is null, midnight will be returned.
     *
     ...
     * hour offset, minute offset, and second offset each given as separate
     * values.
     * The seconds offset can include partial seconds.
     * If time is null, null will be returned. If the offset is null, it will
     * be treated as 0.
     *
     ...
     */
    public static LocalTime TimeOffsetByComponents(LocalTime time,
    ...
    /**
     * Returns a datetime from the given date and time. If any input is null,
     * null will be returned.
     *
    ...
    public static LocalDateTime GetDateTime(LocalDate date, LocalTime time) {
        return date == null || time == null ? null : LocalDateTime.of(date,
                time);
    }

    /**
     * Returns a datetime that is derived from the number of seconds from the
     * base datetime object.
     * If time is null, null will be returned. If seconds is null, time will
     * be returned.
     *
     ...
     */
    public static LocalDateTime DateTimeFromSecondsSince(Integer seconds,
                                                         LocalDateTime time) {
        return time == null ? null : time.plusSeconds(seconds == null ? 0 :
                seconds);
    }

    /**
     * Returns a datetime from the given epoch time specified in seconds.
     * This method assumes the timestamp is in UTC
     ...
     * The value in the time object overwrites the time value in the datetime
     * object
     * so that only the date part is used from the datetime.
     * If datetime is null, null will be returned. If time is null, datetime
     * will be returned.
     *
     ...
     */
    public static LocalDateTime DateTimeFromTime(LocalTime time,
     ...
     * If datetime is null, null will be returned. If offset is null, it will
     * be treated as 0.
     *
     * @return Returns the datetime, with offsets applied from the base
     * datetime.
     */
    public static LocalDateTime DateTimeOffsetByComponents(LocalDateTime datetime, Integer yearOffset,
                                                           ...
                                                           Integer hourOffset
            , Integer minOffset, Integer secondOffset) {
    ...
    /**
     * @return Returns the datetime, with offsets applied from the base
     * datetime with seconds offset.
     * If datetime is null, null will be returned. If seconds is null, it
     * will be treated as 0.
     */
    public static LocalDateTime DateTimeOffsetBySeconds(LocalDateTime datetime, Integer secondsOffset) {
        return datetime == null ? null :
                datetime.plusSeconds(secondsOffset == null ? 0 : secondsOffset);
    }

    /**
     * @return Returns a UNIX epoch time in seconds from the given datetime
     * in UTC time.
    ...
    /**
     * @return Returns a UNIX epoch time in seconds from the given timestamp
     * in UTC time.
    ...
    /**
     * @return Returns the day number of the week from the given date with
     * start of week provided.
     * If date is null, null will be returned. If startOfWeek is null, the
     * date's day number of the week will be returned.
     */
    ...
    public static Integer YearweekFromDate(LocalDate date) {
        // Start of the week is MONDAY and it should have minimum 7 days of
        // the week.
