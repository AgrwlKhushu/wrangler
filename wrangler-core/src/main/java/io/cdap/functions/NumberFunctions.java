...
public final class NumberFunctions {
    ...
    /**
     * @return Returns the mantissa from the given number. Mantissa
     * definition is used from
     ...
     * @return Returns the mantissa from the given number. Mantissa
     * definition is used from
     * https://mathworld.wolfram.com/Mantissa.html. If value is null, it will
     * return 0.
     */
    public static double Mantissa(BigDecimal value) {
        return value == null ? 0d :
                value.subtract(new BigDecimal(value.intValue())).doubleValue();
    }
}
