...
public final class Logical {
     ...
     * of false (0).
     * If the value of expression is false, the Not function returns a value
     * of true (1).
     *
     ...
     * including strings that include
     * an empty string, spaces, or the number 0 and spaces, are logically true.
     * If the logical value of the string is true, the Not function returns a
     * value of false (0).
     * If the logical value of the string is false, the Not function returns
     * a value of true (1).
     *
    ...
    /**
     * Returns the long made from the string argument, which contains a
     * binary representation of "1"s and "0"s.
     *
