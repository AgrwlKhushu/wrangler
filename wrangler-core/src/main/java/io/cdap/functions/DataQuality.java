...
public class DataQuality extends Types {
    ...
    public static boolean inrange(double value, double lower, double upper) {
        Range<Double> range = Range.range(lower, BoundType.CLOSED, upper,
                BoundType.CLOSED);
    ...
    /**
     * Validates if string <code>ip</code> is a valid generic top-level
     * domain or
     * not.
     *
     * @param domain to be validated.
    ...
    /**
     * Validates if string <code>ip</code> is a valid country top-level
     * domain or
     * not.
     *
     * @param domain to be validated.
    ...
    /**
     * Validates if string <code>ip</code> is a valid master credit card
     * number or
     * not.
     *
     * @param cc to be validated.
    ...
    /**
     * Validates if string <code>ip</code> is a valid diner credit card
     * number or
     * not.
     *
     * @param cc to be validated.
    ...
    /**
     * Validates if string <code>ip</code> is a valid discover credit card
     * number or
     * not.
     *
     * @param cc to be validated.
