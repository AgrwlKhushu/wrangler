...
public class GlobalTest {
    ...
    public void testFirstNonNullFound() throws Exception {
        ...
        List<Row> rows = Arrays.asList(new Row("a", null).add("b", null).add(
                "c", "c"));
    ...
    public void testFirstNonNullFoundInBetween() throws Exception {
        ...
        // Run through the wrangling steps.
        List<Row> rows = Arrays.asList(new Row("a", "a").add("b", null).add(
                "c", "c"));
    ...
    public void testPrint() throws Exception {
        ...
        // Run through the wrangling steps.
        List<Row> rows = Arrays.asList(new Row("a", "a").add("b", "b").add("c"
                , "c"));
