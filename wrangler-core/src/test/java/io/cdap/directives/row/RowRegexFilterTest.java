...
public class RowRegexFilterTest {
    ...
    public void testFilterOnNumericValues() throws Exception {
        ...
        List<Row> rows =
                TestingRig.execute(directives.toArray(new String[directives.size()]), originalRows);
        Assert.assertEquals(1, rows.size());
    ...
    public void testFilterKeepDoesntKeepNullValues() throws Exception {
        ...
        List<Row> rows = Arrays.asList(
                new Row("body", "1, \"Archil\", , \"SHAH\", 19, " +
                        "\"2017-06-02\""),
                new Row("body", "2, \"Sameet\", \"andpotatoes\", \"Sapra\", " +
                        "19, \"2017-06-02\""),
