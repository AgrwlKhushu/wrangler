...
public class RowConditionFilterTest {
    ...
    public void testRHSLHSTypeDisconnect() throws Exception {
        String[] directives = new String[]{
                "parse-as-csv body ,",
                "drop body",
                "set columns PassengerId,Survived,Pclass,Name,Sex,Age,SibSp," +
                        "Parch,Ticket,Fare,Cabin,Embarked",
                "filter-row-if-true Fare < 10" // RHS is double, but it's not
                // converted. Check next test case.
        };

        List<Row> rows = Arrays.asList(
                new Row("body", "1,0,3,\"Braund, Mr. Owen Harris\",male,22,1," +
                        "0,A/5 21171,7.25,,S"),
                new Row("body", "2,1,1,\"Cumings, Mrs. John Bradley (Florence" +
                        " Briggs Thayer)\",female," +
    ...
    public void testSameRHSAndLHSType() throws Exception {
        String[] directives = new String[]{
                ...
                "set columns PassengerId,Survived,Pclass,Name,Sex,Age,SibSp," +
                        "Parch,Ticket,Fare,Cabin,Embarked",
                "filter-row-if-true Fare < 10.0" // RHS is changed to double,
                // so LHS will also be changed.
        };
