...
public class SendToErrorTest {
    ...
    /**
     * This tests how to filter records that don't match specified number of
     * columns.
     */
    @Test
    public void testErrorBasedOnColumns() throws Exception {
        String[] directives = new String[]{
                ...
                "drop :body",
                "send-to-error exp:{ this.width() < 4} 'filtering records " +
                        "that dont have 4 columns'",
        ...
        Assert.assertEquals("filtering records that dont have 4 columns " +
                        "(ecode: 1, directive: send-to-error)",
    ...
    public void testMissingVariables() throws Exception {
        String[] directives = new String[]{
                "send-to-error field_calories_cnt < 0 && field_not_exist == " +
                        "'test'"
        };
    ...
    public void testSendToErrorWithMessage() throws Exception {
        ...
        Assert.assertEquals(1, errors.size());
        Assert.assertEquals("Test Message (ecode: 1, directive: " +
                "send-to-error)", errors.get(0).getMessage());
        Assert.assertEquals(2, results.size());
    }
    ...
    public void testSendToErrorWithMetricAndMessage() throws Exception {
        String[] directives = new String[]{
                "send-to-error exp:{field_calories_cnt < 0} test 'Test " +
                        "Message';"
        };
