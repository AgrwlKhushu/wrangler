...
public class ParseDateTest {
    ...
    public void testSimpleDateParserAndDiff() throws Exception {
        ...
        Assert.assertEquals(TimeUnit.HOURS.toMillis(1), rows.get(0).getValue(
                "difference"));
    ...
    public void testSimpleDateWithPatterns() throws Exception {
        ...
        ZonedDateTime zonedDateZeroTime = ZonedDateTime.of(localDate,
                zeroTime, ZoneId.ofOffset("UTC", ZoneOffset.UTC));
        ...
        ZonedDateTime pstDateTime = ZonedDateTime.of(localDate,
                LocalTime.of(14, 45, 11),
                ZoneId.ofOffset("UTC", ZoneOffset.UTC));
        ...
        Assert.assertEquals(ZonedDateTime.of(LocalDate.of(1970, 1, 1),
                        LocalTime.of(18, 45),
                        ZoneId.ofOffset("UTC", ZoneOffset.UTC)),
                rows.get(0).getValue("date13"));
        Assert.assertEquals(ZonedDateTime.of(LocalDate.of(1970, 1, 2),
                        LocalTime.of(2, 45),
                        ZoneId.ofOffset("UTC", ZoneOffset.UTC)),
    ...
    public void testFormatDate() throws Exception {
        ...
        Assert.assertEquals("2016-12-10 06:45:11", rows.get(0).getValue(
                "date6"));
        Assert.assertEquals("12-10-2016 at 14:45:11 UTC",
                rows.get(0).getValue("date7"));
        Assert.assertEquals("10/12/16 06:45:11", rows.get(0).getValue("date8"));
        Assert.assertEquals("2016,12.10T14:45:11.111+0000",
                rows.get(0).getValue("date9"));
        Assert.assertEquals("12.10.2016 06:45:11.111", rows.get(0).getValue(
                "date10"));
        Assert.assertEquals("Sat, 10 Dec 2016 06:45:11",
                rows.get(0).getValue("date11"));
        Assert.assertEquals("Sat, Dec 10, '16", rows.get(0).getValue("date12"));
        Assert.assertEquals("2016.12.10 AD at 14:45:11 UTC",
                rows.get(0).getValue("date15"));
    }
}
