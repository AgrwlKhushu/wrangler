...
public class ExtractRegexGroupsTest {
    ...
    static {
        ...
        DATE_REGEX = String.format("(?:%s%s%s%s%s)|(?:(?:%s%s%s|%s%s%s)%s%s)",
                yearRegex, dateSeparatorRegex, monthRegex, dateSeparatorRegex
                , dayRegex,
        ...
        String timezone = "(?:Z|(?:[+-](?:1[0-2])|(?:0?\\d):[0-5]\\d)|" +
                "(?:\\s[[a-zA-Z]\\s]+))?";
    ...
    public void testEmailRegex() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("two@emails.com, another@one.com", "two" +
                        "@emails.com", "another@one.com"),
                new RegexInputOutput("this.email.is.dotted@dots.com", "this" +
                        ".email.is.dotted@dots.com"),
                new RegexInputOutput("this_underscore@email.com",
                        "this_underscore@email.com"),
                new RegexInputOutput("gmail+has@plusses.com", "gmail+has" +
                        "@plusses.com"),
                new RegexInputOutput("mixed_email.stuff+thing@example.com",
                        "mixed_email.stuff+thing@example.com"),
                new RegexInputOutput("MiXeD@case.com", "MiXeD@case.com"),
                new RegexInputOutput("thishasn0mbers@example.com",
                        "thishasn0mbers@example.com"),
    ...
    public void testSSN() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("123456789 1234578 123 45 6789 abc " +
    ...
    public void testCreditCard() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("1234-5678-9012-3456", "1234-5678-9012" +
                        "-3456"),
                new RegexInputOutput("1234 5678 9012 3456", "1234 5678 9012 " +
                        "3456"),
                new RegexInputOutput("1234 5678 9012 3456, " +
                        "1234-5678-9012-3456", "1234 5678 9012 3456", "1234" +
                        "-5678-9012-3456"),
    ...
    public void testURL() throws Exception {
        String regex = "((?:https?://)?[a-zA-Z0-9\\.-]+\\.[a-zA-Z]{2,6}" +
                "(?:/[\\w\\.-]+)*(?:\\?[\\w\\.&=\\-]+)?)";
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("https://cask.co/test", "https://cask" +
                        ".co/test"),
                new RegexInputOutput("https://cask.co/test/anotherone",
                        "https://cask.co/test/anotherone"),
                new RegexInputOutput("https://cask.co/test/anotherone?query=1" +
                        "&other=2",
    ...
    public void testIPAddress() throws Exception {
        String regex = "((?:(?:0|(?:25[0-5])|(?:2[0-4][1-9])|(?:1\\d\\d)|" +
                "(?:[1-9]\\d?))\\.){3}" +
                "(?:(?:0|(?:25[0-5])|(?:2[0-4][1-9])|(?:1\\d\\d)|" +
                "(?:[1-9]\\d?))))";
    ...
    public void testHTMLTag() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("<tag color=\"orange\">content</tag>",
                        "tag", "content")
        };
        testRegex(regex, regexInputOutputs);
    }
    ...
    public void testLinkTag() throws Exception {
        String regex = "<[aA](?:\\s+[a-zA-Z]+=\".*?\")" +
                "*\\s+[hH][rR][eE][fF]=\"(.*?)\"(?:\\s+[a-zA-Z]+=\".*?\")*>" +
                "(.*)" +
                "</[aA]>";
        RegexInputOutput[] regexInputOutputs = {
                new RegexInputOutput("<a href=\"cask.co\">Cask Data</a>",
                        "cask.co", "Cask Data"),
                new RegexInputOutput("<a target=\"_self\" href=\"http://cask" +
                        ".co/\">Cask Data</a>", "http://cask.co/",
                        "Cask Data"),
                new RegexInputOutput("<a  target=\"_self\"    " +
                        "href=\"http://cask.co/\">Cask Data</a>",
                        "http://cask.co/", "Cask Data"),
                new RegexInputOutput("<a  target=\"_self\"    " +
                        "href=\"http://cask.co/\" type=\"text\">Cask Data</a>",
                        "http://cask.co/", "Cask Data")
        };
        testRegex(regex, regexInputOutputs);
    }
    ...
    public void testTimeRegex() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                ...
                new RegexInputOutput("2:59:04 Pacific Standard Time", "2:59" +
                        ":04 Pacific Standard Time")
        };
        testRegex(regex, regexInputOutputs);
    }
    ...
    public void testDateTimeRegex() throws Exception {
        String regex = String.format("((?:%s)[T\\s](?:%s))", DATE_REGEX,
                TIME_REGEX);
        RegexInputOutput[] regexInputOutputs = {
                new RegexInputOutput("Dec 1, 2015 23:59", "Dec 1, 2015 23:59"),
                new RegexInputOutput("JUL/05/2010 12:59 PM", "JUL/05/2010 " +
                        "12:59 PM"),
                new RegexInputOutput("10/16/97 12:59:59 AM", "10/16/97 " +
                        "12:59:59 AM"),
                new RegexInputOutput("10-10-10 12:59:60 PM", "10-10-10 " +
                        "12:59:60 PM"),
                new RegexInputOutput("Dec 31, 1997 12h59", "Dec 31, 1997 " +
                        "12h59"),
                new RegexInputOutput("2018-03-04T12:59:04Z", "2018-03-04T12" +
                        ":59:04Z"),
                new RegexInputOutput("2016-01-10T02:59:04Z", "2016-01-10T02" +
                        ":59:04Z"),
                new RegexInputOutput("2016-01-10 2:59:04Z", "2016-01-10 " +
                        "2:59:04Z"),
                new RegexInputOutput("2016-01-10 2:59:04 PST", "2016-01-10 " +
                        "2:59:04 PST"),
                new RegexInputOutput("2016-01-10 2:59:04 Pacific Standard " +
                        "Time", "2016-01-10 2:59:04 Pacific Standard Time")
        };
        testRegex(regex, regexInputOutputs);
    }
    ...
    public void testUPSRegex() throws Exception {
        String regex = "(1Z\\s?[0-9a-zA-Z]{3}\\s?[0-9a-zA-Z]{3}\\s?[0-9a-zA-Z" +
                "]{2}\\s?\\d{4}\\s?\\d{4})";
        RegexInputOutput[] regexInputOutputs = {
                new RegexInputOutput("1Z204E380338943508",
                        "1Z204E380338943508"),
                new RegexInputOutput("1Z51062E6893884735",
                        "1Z51062E6893884735"),
                new RegexInputOutput("1ZXF38300382722839",
                        "1ZXF38300382722839"),
                new RegexInputOutput("1ZT675T4YW92275898",
                        "1ZT675T4YW92275898"),
                new RegexInputOutput("1ZW6897XYW00098770",
                        "1ZW6897XYW00098770"),
                new RegexInputOutput("1Z 999 AA1 01 2345 6784", "1Z 999 AA1 " +
                        "01 2345 6784")
        };
        testRegex(regex, regexInputOutputs);
    }
    ...
    public void testISBNRegex() throws Exception {
        ...
        RegexInputOutput[] regexInputOutputs = {
                new RegexInputOutput("ISBN-13: 978-1-56619-909-4", "978-1" +
                        "-56619-909-4"),
    ...
    private void testRegex(String regex,
                           RegexInputOutput[] regexInputOutputs) throws Exception {
        ...
        for (int i = 0; i < regexInputOutputs.length; i++) {
            ...
            Assert.assertEquals(regexInputOutput.input,
                    regexInputOutput.output.length, rows.get(i).width() - 1);
            for (int j = 0; j < regexInputOutput.output.length; j++) {
                Assert.assertEquals(regexInputOutput.output[j],
                        rows.get(i).getValue(j + 1));
            }
        }
    }
