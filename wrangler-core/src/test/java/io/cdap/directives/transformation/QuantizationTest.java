...
public class QuantizationTest {
    ...
    public void testQuanitization() throws Exception {
        String[] directives = new String[]{
                ...
                "quantize hrlywage wagerange 0.0:20.0='LOW',21.0:75" +
                        ".0='MEDIUM',75.1:200.0='HIGH'",
                "set column wagerange (wagerange == null) ? \"NOT FOUND\" : " +
                        "wagerange"
        };

        List<Row> rows = Arrays.asList(
                new Row("__col", "1098,Root,Joltie,01/26/1956,root@joltie.io," +
                        "32,11.79,150 Mars Ave,Palo Alto,CA,USA,32826"),
                new Row("__col", "1091,Root,Joltie,01/26/1956,root1@joltie" +
                        ".io,32,129.13,150 Mars Ave,Palo Alto,CA,USA,32826"),
                new Row("__col", "1092,Root,Joltie,01/26/1956,root@mars.com," +
                        "32,9.54,150 Mars Ave,Palo Alto,CA,USA,32826"),
                new Row("__col", "1093,Root,Joltie,01/26/1956,root@foo.com," +
                        "32,7.89,150 Mars Ave,Palo Alto,CA,USA,32826"),
                new Row("__col", "1094,Root,Joltie,01/26/1956,windy@joltie" +
                        ".io,32,45.67,150 Mars Ave,Palo Alto,CA,USA,32826"),
                new Row("__col", "1094,Root,Joltie,01/26/1956,windy@joltie" +
                        ".io,32,20.7,150 Mars Ave,Palo Alto,CA,USA,32826")
        );
