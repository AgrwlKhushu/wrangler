...
public class SetTypeTest {
    ...
    public void testToInt() throws Exception {
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000").add("int_col", 10000).add(
                                "double_col", 10000.0d)
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000.0f)
                        .add("bytes_col", new byte[]{0, 0, 39, 16}).add(
                                "decimal_col", new BigDecimal("10000"))
        );
        String[] directives = new String[]{
                "set-type str_col int", "set-type int_col i64", "set-type " +
                "double_col integer", "set-type short_col INT",
                "set-type long_col I64", "set-type float_col Integer", "set" +
                "-type bytes_col INTEGER",
    ...
    public void testToShort() throws Exception {
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000").add("int_col", 10000).add(
                        ...
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000.0f)
                        .add("bytes_col", new byte[]{39, 16}).add(
                                "decimal_col", new BigDecimal("10000"))
        );
        String[] directives = new String[]{
                "set-type str_col short", "set-type int_col i32", "set-type " +
                "double_col Short", "set-type short_col I32",
                "set-type long_col SHORT", "set-type float_col short", "set" +
                "-type bytes_col short", "set-type decimal_col SHORT"
        };
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToLong() throws Exception {
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000").add("int_col", 10000).add(
                        ...
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000.0f)
                        .add("bytes_col", new byte[]{0, 0, 0, 0, 0, 0, 39,
                                16}).add("decimal_col", new BigDecimal("10000"))
        );
        String[] directives = new String[]{
                "set-type str_col long", "set-type int_col Long", "set-type " +
                "double_col LONG", "set-type short_col long",
                "set-type long_col Long", "set-type float_col LONG", "set" +
                "-type bytes_col long", "set-type decimal_col long"
        };
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToFloat() throws Exception {
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000.00").add("int_col", 10000).add(
                                "double_col", 10000.00d)
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000.0f)
                        .add("bytes_col", new byte[]{70, 28, 64, 0}).add(
                                "decimal_col", new BigDecimal("10000"))
        );
        String[] directives = new String[]{
                "set-type str_col float", "set-type int_col Float", "set-type" +
                " double_col FLOAT", "set-type short_col float",
                "set-type long_col Float", "set-type float_col FLOAT", "set" +
                "-type bytes_col float", "set-type decimal_col Float"
        };
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToDouble() throws Exception {
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000.00").add("int_col", 10000).add(
                        ...
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000.0f)
                        .add("bytes_col", new byte[]{64, -61, -120, 0, 0, 0,
                                0, 0}).add("decimal_col", new BigDecimal(
                                "10000"))
        );
        String[] directives = new String[]{
                "set-type str_col double", "set-type int_col Double", "set" +
                "-type double_col DOUBLE", "set-type short_col double",
                "set-type long_col Double", "set-type float_col DOUBLE", "set" +
                "-type bytes_col double",
    ...
    public void testToDecimal() throws Exception {
        ...
        String[] directives = new String[]{
                "set-type str_col decimal", "set-type int_col Decimal", "set" +
                "-type double_col DECIMAL",
                "set-type short_col DECIMAL", "set-type long_col Decimal",
                "set-type float_col DECIMAL",
    ...
    public void testToDecimalWithRound() throws Exception {
        List<Row> rows = Collections.singletonList(new Row("scale_1",
                "122.5").add("scale_3", "456.789"));
        String[] directives = new String[]{"set-type scale_1 decimal 0", "set" +
                "-type scale_3 decimal 0 'FLOOR'"};
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToDecimalNegativeScale() throws Exception {
        List<Row> rows = Collections.singletonList(new Row("scale_2", "125" +
                ".45"));
        String[] directives = new String[]{"set-type scale_2 decimal -1 " +
                "'HALF_UP'"};
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToDecimalRoundingRequired() throws Exception {
        List<Row> rows = Collections.singletonList(new Row("scale_2", "123" +
                ".45"));
        String[] directives = new String[]{"set-type scale_2 decimal 1 " +
                "'UNNECESSARY'"};
    ...
    public void testToDecimalInvalidRoundingMode() throws Exception {
        List<Row> rows = Collections.singletonList(new Row("scale_2", "123" +
                ".45"));
        String[] directives = new String[]{"set-type scale_2 decimal 3 " +
                "'RANDOM'"};
        TestingRig.execute(directives, rows);
    }
    ...
    public void testToDecimalWithScalePrecisionAndRoundingMode() throws Exception {
        List<Row> rows = Collections.singletonList(new Row(
                "scale_1_precision_4", "122.5")
                .add("scale_3_precision_6", "456.789"));
        String[] directives = new String[]{"set-type :scale_1_precision_4 " +
                "decimal 0 'FLOOR' prop:{precision=3}",
    ...
    public void testToDecimalWithPrecision() throws Exception {
        List<Row> rows = Collections.singletonList(new Row(
                "scale_1_precision_4", "122.5"));
        String[] directives = new String[]{"set-type :scale_1_precision_4 " +
                "decimal 'FLOOR' prop:{precision=3}"};
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testToDecimalWithInvalidPrecision() throws Exception {
        List<Row> rows = Collections.singletonList(new Row(
                "scale_1_precision_4", "122.5"));
        String[] directives = new String[]{"set-type :scale_1_precision_4 " +
                "decimal 0 'FLOOR' prop:{precision=-1}"};
        TestingRig.execute(directives, rows);
    }
    ...
    public void testToDecimalScaleIsNull() throws Exception {
        ...
        List<Row> results = TestingRig.execute(directives, rows);
        Schema outputSchema = TestingRig.executeAndGetSchema(directives, rows
                , inputSchema);
        Row row = results.get(0);
    ...
    public void testToBoolean() throws Exception {
        List<Row> trueRows = Collections.singletonList(
                new Row("str_1", "true").add("str_2", "True").add("str_3",
                                "TRUE")
                        .add("int_col", 10000).add("double_col", 10000.00d)
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L)
                        .add("float_col", 10000.0f).add("decimal_col",
                                new BigDecimal("10000"))
                        .add("true_col", true)
        );
        List<Row> falseRows = Collections.singletonList(
                new Row("str_1", "false").add("str_2", "False").add("str_3",
                                "FALSE")
                        .add("int_col", -10000).add("double_col", -10000.00d)
                        .add("short_col", new Short("-10000")).add("long_col"
                                , -10000L)
                        .add("float_col", -10000.0f).add("decimal_col",
                                new BigDecimal("10000").negate())
                        .add("false_col", false)
        );
        String[] directives = new String[]{
                "set-type str_1 bool", "set-type str_2 bool", "set-type str_3" +
                " bool", "set-type int_col Bool",
                "set-type double_col BOOL", "set-type short_col boolean",
                "set-type long_col Boolean",
                "set-type float_col BOOLEAN", "set-type bytes_col bool", "set" +
                "-type decimal_col Boolean"
        };
    ...
    public void testToString() throws Exception {
        ...
        List<Row> rows = Collections.singletonList(
                new Row("str_col", "10000").add("int_col", 10000).add(
                                "double_col", 10000d)
                        .add("short_col", new Short("10000")).add("long_col",
                                10000L).add("float_col", 10000f)
                        .add("bytes_col", new byte[]{49, 48, 48, 48, 48}).add("decimal_col", new BigDecimal("10000"))
                        .add("datetime_col", now)
        );
        String[] directives = new String[]{
                "set-type str_col string", "set-type int_col String", "set" +
                "-type double_col STRING", "set-type short_col string",
                "set-type long_col String", "set-type float_col STRING", "set" +
                "-type bytes_col string",
    ...
    public void testToBytes() throws Exception {
        ...
        String[] directives = new String[]{
                "set-type str_col bytes", "set-type int_col Bytes", "set-type" +
                " double_col BYTES", "set-type short_col bytes",
                "set-type long_col Bytes", "set-type float_col BYTES", "set" +
                "-type bytes_col bytes", "set-type decimal_col bytes"
        };
        List<Row> results = TestingRig.execute(directives, rows);
        Row row = results.get(0);
    ...
    public void testGetOutputSchemaForTypeChangedColumn() throws Exception {
        ...
        Assert.assertEquals(outputSchema.getFields().size(),
