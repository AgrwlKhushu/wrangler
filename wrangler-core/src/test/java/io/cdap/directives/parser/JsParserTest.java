...
public class JsParserTest {
    ...
    public void testParseJsonAndJsonPath() throws Exception {
        String[] directives = new String[]{
                ...
                "json-path body_deviceReference_alerts signal_lost $.[*]" +
                        ".['Signal lost']",
        ...
        List<Row> rows = Arrays.asList(
                new Row("body", "{ \"deviceReference\": { \"brand\": " +
                        "\"Samsung \", \"type\": \"Gear S3 frontier\", " +
                        "\"deviceId\": \"SM-R760NDAAXAR\", \"timestamp\": " +
                        "122121212341231, \"OS\": { \"name\": \"Tizen OS\", " +
                        "\"version\": \"2.3.1\" }, \"alerts\": [ { \"Signal " +
                        "lost\": true }, { \"Emergency call\": true }, " +
                        "{ \"Wifi connection lost\": true }, { \"Battery " +
                        "low\": true }, { \"Calories\": 354 } ], " +
                        "\"screenSize\": " +
                        "\"extra-small|small|medium|large\", \"battery\": " +
                        "\"22%\", \"telephoneNumber\": \"+14099594986\", " +
    ...
    public void testFlattenToDepth() throws Exception {
        ...
        List<Row> rows = Arrays.asList(
                new Row("body", "{\"created_at\":\"Mon Feb 06 21:13:37 +0000 " +
                        "2017\",\"id\":828713281267367937," +
                        "\"id_str\":\"828713281267367937\",\"text\":\"Youth " +
                        "is counted sweetest by those who are no longer young" +
                        "." +
                        "\\n#PBBPADALUCKKISSYONG\",\"source\":\"\\u003ca " +
                        "href=\\\"http:\\/\\/twitter" +
                        ".com\\/download\\/iphone\\\" " +
                        "rel=\\\"nofollow\\\"\\u003eTwitter for " +
                        "iPhone\\u003c\\/a\\u003e\",\"truncated\":false," +
                        "\"in_reply_to_status_id\"" +
                        ":null,\"in_reply_to_status_id_str\":null," +
                        "\"in_reply_to_user_id\":null," +
                        "\"in_reply_to_user_id_str\":null,\"in_" +
                        "reply_to_screen_name\":null," +
                        "\"user\":{\"id\":520417116,\"id_str\":\"520417116\"," +
                        "\"name\":\"glenda andres\"," +
                        "\"screen_name\":\"glenda_andres\"," +
                        "\"location\":\"Israel\",\"url\":null," +
                        "\"description\":\"volleyball,badminton\"," +
                        "\"protected\":false,\"verified\":false," +
                        "\"followers_count\":12,\"friends_count\":94," +
                        "\"listed_count\":1," +
                        "\"favourites_count\":42,\"statuses_count\":595," +
                        "\"created_at\":\"Sat Mar 10 13:57:16 +0000 2012\"," +
                        "\"utc_offset" +
                        "\":null,\"time_zone\":null,\"geo_enabled\":false," +
                        "\"lang\":\"en\",\"contributors_enabled\":false," +
                        "\"is_translator" +
                        "\":false,\"profile_background_color\":\"C0DEED\"," +
                        ...
                        "\"profile_link_color\":\"1DA1F2\",\"profile_" +
                        ...
                        ".com\\/profile_images\\" +
                        "/680735812972052480\\/hsvuZASG_normal.jpg\"," +
                        "\"profile_image_url_https\":\"https:\\/\\/pbs.twimg" +
                        ".com\\/" +
                        "profile_" +
                        "images\\/680735812972052480\\/hsvuZASG_normal.jpg\"," +
                        "\"profile_banner_url\":\"https:\\/\\/pbs.twimg" +
                        ".com\\/" +
                        "profile_" +
                        "banners\\/520417116\\/1451511037\"," +
                        ...
                        "\"entities\":" +
                        "{\"hashtags\":[{\"text\":\"PBBPADALUCKKISSYONG\"," +
                        "\"indices\":[60,80]}],\"urls\":[]," +
                        "\"user_mentions\":[]," +
                        "\"symbols\":[]},\"favorited\":false," +
                        "\"retweeted\":false,\"filter_level\":\"low\"," +
                        "\"lang\":\"en\"," +
