...
public class BasicStatisticsTest {
    ...
    public void testFinderXMLFormat() throws Exception {
        FinderEngine engine = new FinderEngine("wrangler-finder.xml", true,
                false);
    ...
    public void testMetaBasic() throws Exception {
        ...
        List<Row> rows = Arrays.asList(
                new Row("body", "1234.45,650-897-3839,111-11-1111,32826," +
                        "02/29/2000,\"$1234.56\",http://www.yahoo.com"),
                new Row("body", "45.56,670-897-3839,111-12-1111,32826," +
                        "02/01/2011,\"$56,789\",http://mars.io"),
                new Row("body", "45.56,670-897-3839,222,32826,9/14/2016,\"\"," +
                        "http://mars.io")
        );
