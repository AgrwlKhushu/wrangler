...
public class MapArgumentsTest {
    ...
    public void testWithAllRequiredFields() throws Exception {
        ...
        Arguments arguments = new MapArguments(builder.build(),
                iterator.next());
    ...
    public void testMultipleArgumentsOptional() throws Exception {
        ...
        CompileStatus status2 = compiler.compile("parse-as-csv :body ' ' " +
                "true;");
        CompileStatus status3 = compiler.compile("parse-as-csv :body ' ' true" +
                " exp: { type == '002' };");
        CompileStatus status4 = compiler.compile("parse-as-csv :body exp: { " +
                "type == '002' };");
    ...
    public void testTextLists() throws Exception {
        Compiler compiler = new RecipeCompiler();
        CompileStatus status = compiler.compile("remove-sensitive-data :body " +
                "\"ALL_BASIC\", \"AGE\";");
        ...
        List<String> infoTypes =
                ((TextList) arguments.value("infoTypes")).value();
