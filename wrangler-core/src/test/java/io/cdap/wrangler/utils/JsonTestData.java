...
public final class JsonTestData {
    ...
    public static final String FB_JSON = "{"
            ...
            + "      \"thumbnail\":{"
            + "        \"default\":\"http://i.ytimg" +
            ".com/vi/hYB0mn5zh2c/default.jpg\","
            + "        \"hqDefault\":\"http://i.ytimg" +
            ".com/vi/hYB0mn5zh2c/hqdefault.jpg\" },"
            + "        \"player\":{ \"default\":\"http://www.youtube" +
            ".com/watch?vu003dhYB0mn5zh2c\" },"
            + "        \"content\":{ "
            + "          \"a\":\"rtsp://v5.cache3.c.youtube.com/CiILENy.." +
            "./0/0/0/video.3gp\","
            + "          \"t\":\"http://www.youtube.com/v/hYB0mn5zh2c?f...\","
            + "          \"y\":\"rtsp://v1.cache1.c.youtube.com/CiILENy.." +
            "./0/0/0/video.3gp\" },"
            + "          \"duration\":2840, \"aspectRatio\":\"widescreen\", " +
            "\"rating\":4.63, \"ratingCount\":68,"
            + "          \"viewCount\":220101, \"favoriteCount\":201, " +
            "\"commentCount\":22, "
            + "          \"status\":{ \"value\":\"restricted\", " +
            "\"reason\":\"limitedSyndication\" },"
            + "          \"accessControl\":{ "
            + "            \"syndicate\":\"allowed\", " +
            "\"commentVote\":\"allowed\", \"rate\":\"allowed\", " +
            "\"list\":\"allowed\","
            + "            \"comment\":\"allowed\", \"embed\":\"allowed\", " +
            "\"videoRespond\":\"moderated\" }"
            + "       }"
            + "     ]"
            + "   }"
            + " }";
    public static final String EMPTY_OBJECT = "{ \"dividesplitdetails" +
            "\":{\"type0\":[]}}";
    public static final String NULL_OBJECT = "{ \"dividesplitdetails" +
            "\":{\"type0\":null, \"type1\":0}}";
}
