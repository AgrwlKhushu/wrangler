...
public class ObjectSerDeTest {
    ...
    public void testSerDe() throws Exception {
        ...
        Assert.assertEquals(rows.get(0).getColumn(0),
                newRows.get(0).getColumn(0));
        Assert.assertEquals(rows.get(0).getColumn(1),
                newRows.get(0).getColumn(1));
        Assert.assertEquals(rows.get(0).getColumn(2),
                newRows.get(0).getColumn(2));
    }
    ...
    public void testLogicalTypeSerDe() throws Exception {
        ...
        firstRow.add("timestamp", ZonedDateTime.of(2018, 11, 11, 11, 11, 11,
                0, ZoneId.of("UTC")));
    ...
    public void testRemoteDirectiveResponseSerDe() throws Exception {
        ...
        firstRow.add("id", 1);
        expectedRows.add(firstRow);
        Schema expectedSchema = Schema.recordOf(Schema.Field.of("id",
                Schema.of(Schema.Type.INT)));
        RemoteDirectiveResponse expectedResponse =
        ...
        Assert.assertEquals(expectedResponse.getRows().size(),
                actualResponse.getRows().size());
        Assert.assertEquals(expectedResponse.getOutputSchema(),
                actualResponse.getOutputSchema());
    }
}
