...
public class ArithmeticOperationsTest {
    ...
    public void testAdd() throws Exception {
        ...
        // Test 1 value
        Assert.assertEquals((short) 5, ArithmeticOperations.add((short) 5));
        // short
        Assert.assertEquals(5, ArithmeticOperations.add(5)); // int
        Assert.assertEquals((long) 5, ArithmeticOperations.add((long) 5)); //
        // long
        Assert.assertEquals((float) 5, ArithmeticOperations.add((float) 5));
        // float
        ...
        // Test one null value
        Assert.assertNull(ArithmeticOperations.add((short) 2, null,
                (short) 3)); // short
        ...
        Assert.assertNull(ArithmeticOperations.add((float) 2, null,
                (float) 3)); // float
        ...
        Assert.assertEquals(5,
                ArithmeticOperations.add((short) 2, 2, (short) 1)); // short
        // + int
        Assert.assertEquals((long) 5,
                ArithmeticOperations.add(2, (long) 2, 1)); // int + long
        Assert.assertEquals((float) 5,
                ArithmeticOperations.add((long) 2, (float) 2, (long) 1)); //
        // long + float
        Assert.assertEquals((double) 5,
                ArithmeticOperations.add((float) 2, 2.0, (float) 1)); //
        // float + double
        Assert.assertEquals(BigDecimal.valueOf(5),
                ArithmeticOperations.add(2.0, BigDecimal.valueOf(2), 1.0));
        // double + BigDecimal

        // Test multiple types (all)
        Assert.assertEquals(BigDecimal.valueOf(21),
                ArithmeticOperations.add((short) 1,
                        2,
                        (long) 3,
                        (float) 4,
                        5.0,
    ...
    public void testMinus() throws Exception {
        ...
        // Test same type
        Assert.assertEquals((short) 2, ArithmeticOperations.minus((short) 10,
                (short) 8)); // Short
        Assert.assertEquals(2, ArithmeticOperations.minus(10, 8)); // Integer
        Assert.assertEquals((long) 2, ArithmeticOperations.minus((long) 10,
                (long) 8)); // Long
        Assert.assertEquals((float) 2.5,
                (float) ArithmeticOperations.minus((float) 10.7, (float) 8.2)
                , DELTA); // Float
        Assert.assertEquals(2.5, (double) ArithmeticOperations.minus(10.7,
                8.2), DELTA); // Double
        Assert.assertEquals(BigDecimal.valueOf(2.5),
                ArithmeticOperations.minus(BigDecimal.valueOf(10.7),
                        BigDecimal.valueOf(8.2))); // BigDecimal

        // Test different types; expected behavior is to output the most
        // "general" type
        Assert.assertEquals(2, ArithmeticOperations.minus((short) 10, 8)); //
        // Short + Integer
        Assert.assertEquals((long) 2, ArithmeticOperations.minus(10,
                (long) 8)); // Integer + Long
        Assert.assertEquals((float) 2,
                (float) ArithmeticOperations.minus((long) 10, (float) 8),
                DELTA); // Long + Float
        Assert.assertEquals(2.5,
                (double) ArithmeticOperations.minus((float) 10.7, 8.2),
                DELTA); // Float + Double
        Assert.assertEquals(BigDecimal.valueOf(2.5),
                ArithmeticOperations.minus(10.7, BigDecimal.valueOf(8.2)));
        // Double + BigDecimal
    }
    ...
    public void testMultiply() throws Exception {
        ...
        // Test 1 value
        Assert.assertEquals((short) 5,
                ArithmeticOperations.multiply((short) 5)); // short
        Assert.assertEquals(5, ArithmeticOperations.multiply(5)); // int
        Assert.assertEquals((long) 5,
                ArithmeticOperations.multiply((long) 5)); // long
        Assert.assertEquals((float) 5,
                ArithmeticOperations.multiply((float) 5)); // float
        Assert.assertEquals(5.0, ArithmeticOperations.multiply(5.0)); // double
        Assert.assertEquals(BigDecimal.valueOf(5),
                ArithmeticOperations.multiply(BigDecimal.valueOf(5))); //
        // BigDecimal
        ...
        Assert.assertEquals(3.0, ArithmeticOperations.multiply(1.0, 3.0)); //
        // double
        ...
        // Test one null value
        Assert.assertNull(ArithmeticOperations.multiply((short) 2, null,
                (short) 3)); // short
        Assert.assertNull(ArithmeticOperations.multiply(2, null, 3)); // int
        Assert.assertNull(ArithmeticOperations.multiply((long) 2, null,
                (long) 3)); // long
        Assert.assertNull(ArithmeticOperations.multiply((float) 2, null,
                (float) 3)); // float
        Assert.assertNull(ArithmeticOperations.multiply(2.0, null, 3.0)); //
        // double
        ...
        Assert.assertEquals(4,
                ArithmeticOperations.multiply((short) 2, 2, (short) 1)); //
        // short + int
        Assert.assertEquals((long) 4,
        ...
        Assert.assertEquals((double) 4,
                ArithmeticOperations.multiply((float) 2, 2.0, (float) 1)); //
        // float + double
    ...
    public void testDivideq() throws Exception {
        ...
        // Test same type
        // Expected behavior is to output Double, unless any input has type
        // BigDecimal
        Assert.assertEquals(2.4,
                (double) ArithmeticOperations.divideq((short) 12, (short) 5),
                DELTA); // Short
        Assert.assertEquals(2.4, (double) ArithmeticOperations.divideq(12, 5)
                , DELTA); // Integer
        Assert.assertEquals(2.4,
                (double) ArithmeticOperations.divideq((long) 12, (long) 5),
                DELTA); // Long
        Assert.assertEquals(30.25,
                (double) ArithmeticOperations.divideq((float) 12.1,
                        (float) 0.4),
                DELTA); // Float
        Assert.assertEquals(30.25, (double) ArithmeticOperations.divideq(12.1
                , 0.4), DELTA); // Double
        Assert.assertEquals(BigDecimal.valueOf(30.3),
                ArithmeticOperations.divideq(BigDecimal.valueOf(9.09),
                        BigDecimal.valueOf(0.3))); // BigDecimal

        // Test different types
        Assert.assertEquals(2.4,
                (double) ArithmeticOperations.divideq((short) 12, 5), DELTA); // Short + Integer
        Assert.assertEquals(2.4, (double) ArithmeticOperations.divideq(12,
                (long) 5), DELTA); // Integer + Long
        Assert.assertEquals(2.4,
                (double) ArithmeticOperations.divideq((long) 12,
                        (float) 5.0), DELTA); // Long + Float
        Assert.assertEquals(30.25,
                (double) ArithmeticOperations.divideq((float) 12.1, 0.4),
                DELTA); // Float + Double
        Assert.assertEquals(BigDecimal.valueOf(30.3),
                ArithmeticOperations.divideq(9.09, BigDecimal.valueOf(0.3))); // Double + BigDecimal

        // Test division by 0
        Assert.assertEquals(null, ArithmeticOperations.divideq(5, 0)); //
        // Integer 0
        Assert.assertEquals(null,
                ArithmeticOperations.divideq(5, (double) 0)); // Double 0
        Assert.assertEquals(null, ArithmeticOperations.divideq(5,
                BigDecimal.valueOf(0))); // BigDecimal 0
    }
    ...
    public void testDivider() throws Exception {
        ...
        // Test same type
        Assert.assertEquals(2, ArithmeticOperations.divider((short) 12,
                (short) 5)); // Short
        Assert.assertEquals(2, ArithmeticOperations.divider(12, 5)); // Integer
        Assert.assertEquals((long) 2, ArithmeticOperations.divider((long) 12,
                (long) 5)); // Long
        Assert.assertEquals((float) 0.2,
                (float) ArithmeticOperations.divider((float) 12.2,
                        (float) 0.5), DELTA); // Float
        Assert.assertEquals(0.2, (double) ArithmeticOperations.divider(12.2,
                0.5), DELTA); // Double
        Assert.assertEquals(BigDecimal.valueOf(0.2),
                ArithmeticOperations.divider(BigDecimal.valueOf(12.2),
                        BigDecimal.valueOf(0.5))); // BigDecimal

        // Test different types; expected behavior is to output the most
        // "general" type
        Assert.assertEquals(2, ArithmeticOperations.divider((short) 12, 5));
        // Short + Integer
        Assert.assertEquals((long) 2, ArithmeticOperations.divider(12,
                (long) 5)); // Integer + Long
        Assert.assertEquals((float) 2.0,
                (float) ArithmeticOperations.divider((long) 12,
                        (float) 5.0), DELTA); // Long + Float
        Assert.assertEquals(0.2,
                (double) ArithmeticOperations.divider((float) 12.2, 0.5),
                DELTA); // Float + Double
        Assert.assertEquals(BigDecimal.valueOf(0.2),
                ArithmeticOperations.divider(12.2, BigDecimal.valueOf(0.5))); // Double + BigDecimal

        // Test division by 0
        Assert.assertEquals(null, ArithmeticOperations.divider(5, 0)); //
        // Integer 0
        Assert.assertEquals(null,
                ArithmeticOperations.divider(5, (double) 0)); // Double 0
        Assert.assertEquals(null, ArithmeticOperations.divider(5,
                BigDecimal.valueOf(0))); // BigDecimal 0
    }
    ...
    public void testLCM() throws Exception {
        ...
        // Test same type
        Assert.assertEquals((short) 36, ArithmeticOperations.lcm((short) 12,
                (short) 18)); // Short
        Assert.assertEquals(36, ArithmeticOperations.lcm(12, 18)); // Integer
        Assert.assertEquals((long) 36, ArithmeticOperations.lcm((long) 12,
                (long) 18)); // Long
        Assert.assertEquals((float) 2262.5,
                ArithmeticOperations.lcm((float) 12.5, (float) 18.1)); // Float
        Assert.assertEquals(2262.5, ArithmeticOperations.lcm(12.5, 18.1)); //
        // Double
        Assert.assertEquals(BigDecimal.valueOf(2262.5),
                ArithmeticOperations.lcm(BigDecimal.valueOf(12.5),
                        BigDecimal.valueOf(18.1))); // BigDecimal

        // Test different types; expected behavior is to output the most
        // "general" type
        Assert.assertEquals(36, ArithmeticOperations.lcm((short) 12, 18)); //
        // Short + Integer
        Assert.assertEquals((long) 36, ArithmeticOperations.lcm(12,
                (long) 18)); // Integer + Long
        Assert.assertEquals((float) 36.0, ArithmeticOperations.lcm((long) 12,
                (float) 18.0)); // Long + Float
        Assert.assertEquals(2262.5, ArithmeticOperations.lcm((float) 12.5,
                18.1)); // Float + Double
        Assert.assertEquals(BigDecimal.valueOf(2262.5),
                ArithmeticOperations.lcm(12.5, BigDecimal.valueOf(18.1))); //
        // Double + BigDecimal
    }
    ...
    public void testEqual() throws Exception {
        ...
        // Test precision
        Assert.assertFalse(ArithmeticOperations.equal(BigDecimal.ONE,
    ...
    public void testMax() throws DirectiveExecutionException {
        ...
        Assert.assertEquals((float) 4, ArithmeticOperations.max((long) 4,
                (float) 2,
                (long) 4));
        Assert.assertEquals(3.0, ArithmeticOperations.max((float) 3, 2.0,
                (float) 3));
        Assert.assertEquals(BigDecimal.valueOf(2.0),
                ArithmeticOperations.max(2.0,
                        BigDecimal.valueOf(1.0),
                        2.0));
    ...
    public void testMin() throws DirectiveExecutionException {
        ...
        Assert.assertEquals((float) 4, ArithmeticOperations.min((long) 4,
                (float) 5,
                (long) 4));
        Assert.assertEquals(2.0, ArithmeticOperations.min((float) 2, 3.0,
                (float) 2));
        Assert.assertEquals(BigDecimal.valueOf(1.0),
                ArithmeticOperations.min(1.0,
