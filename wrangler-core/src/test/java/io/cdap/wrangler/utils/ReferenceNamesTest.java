...
public class ReferenceNamesTest {
    ...
    public void testCleanse() {
        // valid names
        Assert.assertEquals("111-22-33.csv",
                ReferenceNames.cleanseReferenceName("111-22-33.csv"));
        Assert.assertEquals("abc$2.txt", ReferenceNames.cleanseReferenceName(
                "abc$2.txt"));
        Assert.assertEquals("1$-2.random",
                ReferenceNames.cleanseReferenceName("1$-2.random"));

        // invalid names
        Assert.assertEquals("111-22-331.csv",
                ReferenceNames.cleanseReferenceName("111-22-33(1).csv"));
        Assert.assertEquals("1.csv", ReferenceNames.cleanseReferenceName("1*!" +
                ".csv"));
