...
public class SchemaConverterTest {
    ...
    public void conversionTest() throws Exception {
        ...
        for (String test : TESTS) {
            ...
            if (schema.getType() != Schema.Type.RECORD) {
                schema = Schema.recordOf("array", Schema.Field.of("array",
                        schema));
            }
            Assert.assertNotNull(schema);
            List<StructuredRecord> structuredRecords =
                    recordConvertor.toStructureRecord(rows, schema);
            String decode =
                    StructuredRecordStringConverter.toJsonString(structuredRecords.get(0));
            JsonElement originalObject = parser.parse(test);
            JsonElement roundTripObject =
                    parser.parse(decode).getAsJsonObject().get("body");
    ...
    public void testLogicalType() throws Exception {
        ...
        Schema expected = Schema.recordOf("testRecord",
                ...
                Schema.Field.of("d", Schema.nullableOf(Schema.decimalOf(38,
                        5))),
                Schema.Field
                        .of("datetime",
    ...
    public void testRecordType() throws Exception {
        ...
        memberRow.add("timestamp", ZonedDateTime.of(2018, 11, 11, 11, 11, 11,
                0, ZoneId.of("UTC")));
        ...
        String newRecordTypeName =
                recordTypeName + namingSchema.getRecordName();
        Schema memberSchema =
                Schema.nullableOf(Schema.recordOf(newRecordTypeName, fields));

        Schema expected = Schema.recordOf("testRecord",
                Schema.Field.of(recordTypeName, memberSchema));
        Assert.assertEquals(expected, actual);
    }
