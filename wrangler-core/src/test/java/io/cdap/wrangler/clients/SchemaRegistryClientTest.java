 ...
 * <p>
 * NOTE: Due to issues with the Guava inclusion in the core, the
 * {@link io.cdap.cdap.test.TestBase} has
 * issue loading class. Hence, this test simulates the service and not
 * actually tests the service.
 */
public class SchemaRegistryClientTest {
    ...
    public static class ServiceHandler implements HttpHandler {
        ...
        public void append(HttpRequest request, HttpResponder responder,
            ...
            OKResponse response = new OKResponse(200, "Successfully created " +
                    "schema entry with id '%s', name '%s'");
        ...
        public void get(HttpRequest request, HttpResponder responder,
            ...
            object.addProperty("specification", Bytes.toHexString(("{\"foo\" " +
                    ":" +
