...
public class ConvertStringTest {
    ...
    public void testRemoveTrailingAndLeading() {
        ...
        Assert.assertEquals(expected, convertString.removeTrailingAndLeading(
                "  abc  "));
        //$NON-NLS-2$
        Assert.assertEquals("ab c", convertString.removeTrailingAndLeading(" " +
                "ab c"));
        //$NON-NLS-2$
        Assert.assertEquals("a b c", convertString.removeTrailingAndLeading(
                " a b c "));
        ...
        Assert.assertEquals("a" + "\t" + "bc",
                convertString.removeTrailingAndLeading("\t" + "a" + "\t" +
                        "bc", "\t"));
        //$NON-NLS-2$ //$NON-NLS-3$
        Assert.assertEquals("\t" + expected,
                convertString.removeTrailingAndLeading("\t" + "abc "));
        //$NON-NLS-2$ //$NON-NLS-3
        ...
        Assert.assertEquals(expected,
                convertString.removeTrailingAndLeading(expected, "\r"));
        //$NON-NLS-2$
        Assert.assertEquals(expected, convertString.removeTrailingAndLeading(
                "\r" + expected, "\r"));
        //$NON-NLS-2$ //$NON-NLS-3$
        ...
        //$NON-NLS-2$ //$NON-NLS-3$
        Assert.assertEquals("bc", convertString.removeTrailingAndLeading(" " +
                "abc", " a"));
        //$NON-NLS-2$ //$NON-NLS-3$
        Assert.assertEquals(" a", convertString.removeTrailingAndLeading(" " +
                "abc", "bc"));
        //$NON-NLS-2$ //$NON-NLS-3$
        Assert.assertEquals("ab", convertString.removeTrailingAndLeading(
                "cabc", "c"));
    }
    ...
    public void testRemoveTrailingAndLeadingWhitespaces() {
        ...
        Assert.assertEquals(expected,
                convertString.removeTrailingAndLeadingWhitespaces(inputData));
    }
    ...
    public void testremoveDuplicate_CR() {
        ...
        Assert.assertEquals("a\rbccccdeaa\ry",
                convertString.removeRepeatedChar(input));
    }
    ...
    public void testremoveDuplicate_TAB() {
        ...
        Assert.assertEquals("a\tbccccdeaa\ty",
                convertString.removeRepeatedChar(input));
    }
    ...
    public void testremoveWhiteSpace() {
        ...
        input = "a\u0085\u0085\u0085b\u00A0\u00A0c\u1680\u1680d\u180E\u180Ee" +
                ...
                + "\u2002\u2002h\u2003\u2003i\u2004\u2004";
        cleanStr = convertString.removeRepeatedWhitespaces(input);
        Assert.assertEquals("a\u0085b\u00A0c\u1680d\u180Ee\u2000f\u2001g" +
                "\u2002h\u2003i\u2004", cleanStr);
