...
public class ConvertDistancesTest {
    ...
    public void testConvertDoubleNan() {
        ...
        ConvertDistances converter =
                new ConvertDistances(ConvertDistances.Distance.MILE,
    ...
    public void testConvertMaxValue() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.LIGHT_YEAR,
                        ConvertDistances.Distance.MILLIMETER);
        Assert.assertEquals(Double.POSITIVE_INFINITY, converter0.convert(max)
                , delta);
        ConvertDistances converter1 =
                new ConvertDistances(ConvertDistances.Distance.MILLIMETER,
                        ConvertDistances.Distance.LIGHT_YEAR);
        Assert.assertEquals(1.900163142869793E289, converter1.convert(max),
                delta);
    }
    ...
    public void testConvertCentimeter() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.CENTIMETER,
                        ConvertDistances.Distance.CENTIMETER);
    ...
    public void testConvertDecimeter() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.DECIMETER,
                        ConvertDistances.Distance.DECIMETER);
    ...
    public void testConvertMeter() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.METER,
                        ConvertDistances.Distance.METER);
    ...
    public void testConvertHectometer() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.HECTOMETER,
                        ConvertDistances.Distance.HECTOMETER);
    ...
    public void testConvertKilometer() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.KILOMETER,
                        ConvertDistances.Distance.KILOMETER);
    ...
    public void testConvertInch() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.INCH,
                        ConvertDistances.Distance.INCH);
    ...
    public void testConvertFoot() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.FOOT,
                        ConvertDistances.Distance.FOOT);
    ...
    public void testConvertYard() {
        ...
        ConvertDistances converter0 =
                new ConvertDistances(ConvertDistances.Distance.YARD,
                        ConvertDistances.Distance.YARD);
