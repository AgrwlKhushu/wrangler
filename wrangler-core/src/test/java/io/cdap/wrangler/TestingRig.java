...
public final class TestingRig {
     ...
     */
    public static Schema executeAndGetSchema(String[] recipe, List<Row> rows,
                                             Schema inputSchema)
            throws DirectiveParseException, DirectiveLoadException,
            RecipeException {
        ExecutorContext context =
                new TestingPipelineContext().setSchemaManagementEnabled();
    ...
    /**
     * Executes the directives on the record specified and returns the
     * results as well as the errors.
     *
     * @param recipe to be executed.
     * @param rows   to be executed on directives.
    ...
    public static Pair<List<Row>, List<Row>> executeWithErrors(String[] recipe, List<Row> rows)
            throws RecipeException, DirectiveParseException,
            DirectiveLoadException, DirectiveNotFoundException {
