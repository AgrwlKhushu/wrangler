...
/**
 * Response returned when a {@link io.cdap.wrangler.api.RecipeException}
 * occurs. Contains information about row index
...
public class RecipeExceptionResponse<T> extends ServiceResponse<T> {
    ...
    public RecipeExceptionResponse(String message, Integer rowIndex,
