...
public final class Connection extends ConnectionMeta {
    ...
    public Connection(NamespacedId id, ConnectionType type, String name,
                      String description, long created, long updated,
    ...
    public static class Builder extends ConnectionMeta.Builder<Builder> {
        ...
        public Connection build() {
            ...
            return new Connection(id, type, name, description, created,
                    updated, properties, preconfigured);
        }
    }
}
