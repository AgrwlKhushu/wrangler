...
public class SampleSpec {
    ...
    // This gives the different methods the current connection supports for
    // sampling
    // (e.g. first N rows, randomized, stratified)
    private final Set<SampleType> supportedSampleTypes;
    // We store the SampleRequest so that the frontend knows the most recent
    // sampling action (if any)
    // when it gets passed the SampleSpec
    private final SampleRequest sampleRequest;

    public SampleSpec(String connectionName, String connectionType,
    ...
    public SampleSpec(String connectionName, String connectionType,
                      @Nullable String path,
                      Set<StageSpec> relatedPlugins) {
        this(connectionName, connectionType, path, relatedPlugins,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(connectionName, that.connectionName) &&
                ...
                Objects.equals(supportedSampleTypes,
                        that.supportedSampleTypes) &&
                Objects.equals(sampleRequest, that.sampleRequest);
    }

    @Override
    public int hashCode() {
        return Objects.hash(connectionName, connectionType, path,
                relatedPlugins, supportedSampleTypes, sampleRequest);
    }
}
