...
public class Workspace {
    ...
    // this is null when the sample does not have a spec, currently only
    // example is directly upload data to wrangler
    private final SampleSpec sampleSpec;
    // this is for insights page in UI
    private final JsonObject insights;

    private Workspace(String workspaceName, String workspaceId,
                      List<String> directives,
                      long createdTimeMillis, long updatedTimeMillis,
                      @Nullable SampleSpec sampleSpec,
                      JsonObject insights) {
    ...
    public static Builder builder(Workspace existing) {
        return new Builder(existing.getWorkspaceName(),
    ...
    public static class Builder {
        ...
        public Workspace build() {
            return new Workspace(workspaceName, workspaceId, directives,
                    createdTimeMillis, updatedTimeMillis, sampleSpec,
                    insights);
        }
    }
}
