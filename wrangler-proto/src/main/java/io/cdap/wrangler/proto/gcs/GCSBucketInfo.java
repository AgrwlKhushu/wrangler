...
public class GCSBucketInfo {
    ...
    public GCSBucketInfo(String name, String type, String owner,
                         long metaGeneration, String generatedId,
        ...
        // this is constant, but is part of the response so must be a field
        // in this class
        this.directory = true;
    }
}
