 ...
 * For example, why are 'connection' (actually connection type) and
 * connection id in this object
...
public class ConnectionSample {
    ...
    public ConnectionSample(String id, String name, String connection,
                            String sampler, String connectionid) {
        this.id = id;
        this.name = name;
