...
public class ConnectionMeta {
    ...
    protected ConnectionMeta(ConnectionType type, String name,
                             String description,
    ...
    /**
     * Should be called if this object is created through deserialization of
     * user input.
     *
    ...
    public void validate() {
        if (name == null || name.isEmpty()) {
            throw new IllegalArgumentException("A connection name must be " +
                    "specified.");
        }
        if (type == null) {
            throw new IllegalArgumentException("A connection type must be " +
                    "specified.");
        }
    }
    ...
    public static class Builder<T extends Builder> {
        ...
        public ConnectionMeta build() {
            ConnectionMeta meta = new ConnectionMeta(type, name, description,
                    properties);
            meta.validate();
            return meta;
        }
