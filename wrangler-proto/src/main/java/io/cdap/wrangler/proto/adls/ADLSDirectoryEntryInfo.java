...
public class ADLSDirectoryEntryInfo {
    ...
    private ADLSDirectoryEntryInfo(String name, String type,
                                   @Nullable String path,
                                   @Nullable String owner,
                                   @Nullable String group,
                                   @Nullable String permission,
                                   @Nullable Long displaySize,
                                   @Nullable String modifiedTime,
                                   @Nullable Boolean directory,
    ...
    public static class Builder {
        ...
        public ADLSDirectoryEntryInfo build() {
            return new ADLSDirectoryEntryInfo(name, type, path, user, group,
                    permission, displaySize, modifiedTime,
