...
public final class SchemaEntry extends NamespacedId {
    ...
    public SchemaEntry(NamespacedId id, String name, String description,
                       SchemaDescriptorType type,
                       Set<Long> versions, @Nullable byte[] specification,
        ...
        this.specification = specification == null ? null :
                Bytes.toHexString(specification);
    ...
    public byte[] getSpecification() {
        return specification == null ? null :
                Bytes.fromHexString(specification);
    }
    ...
    public int hashCode() {
        return Objects.hash(super.hashCode(), name, description, type,
                versions, specification, current);
    }
}
