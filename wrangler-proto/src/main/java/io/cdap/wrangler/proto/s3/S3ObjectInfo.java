...
public class S3ObjectInfo {
    ...
    private S3ObjectInfo(String name, String type, @Nullable String path,
                         @Nullable String owner,
                         @Nullable String storageClass,
                         @Nullable Long created, @Nullable Long lastModified,
                         @Nullable Long size, @Nullable Boolean directory,
    ...
    public static class Builder {
        ...
        public S3ObjectInfo build() {
            return new S3ObjectInfo(name, type, path, owner, storageClass,
                    created, lastModified, size,
